"use strict";(self.webpackChunk_jupyterlab_application_top=self.webpackChunk_jupyterlab_application_top||[]).push([["1997"],{98060(e,t,i){let s,o,n,a,r,l;i.r(t),i.d(t,{listboxOptionTemplate:()=>ig,pickerMenuTemplate:()=>iA,DelegatesARIATextbox:()=>iW,DelegatesARIASelect:()=>sr,Anchor:()=>ek,FlyoutPosTallestFill:()=>eH,FoundationElement:()=>ep,TextAreaResize:()=>sS,applyMixins:()=>eb,ResolverBuilder:()=>y,Combobox:()=>tS,TreeView:()=>sX,reflectAttributes:()=>ir,FlyoutPosBottom:()=>eF,composedContains:()=>tz,Skeleton:()=>sd,ignore:()=>z,radioGroupTemplate:()=>i0,TreeItem:()=>sK,Toolbar:()=>sV,interactiveCalendarGridTemplate:()=>td,DI:()=>E,ListboxElement:()=>iy,calendarWeekdayTemplate:()=>tr,supportsElementInternals:()=>eG,Flipper:()=>ib,FormAssociated:()=>eQ,pickerMenuOptionTemplate:()=>iF,pickerTemplate:()=>iO,TextArea:()=>sM,isListboxOption:()=>t$,ComboboxAutocomplete:()=>tD,dataGridTemplate:()=>tL,tabTemplate:()=>sE,breadcrumbItemTemplate:()=>eq,DelegatesARIASearch:()=>ss,Divider:()=>ip,DelegatesARIALink:()=>eE,whitespaceFilter:()=>i6,focusVisible:()=>s8,darkModeStylesheetBehavior:()=>sZ,DataGridRow:()=>to,ResolverImpl:()=>q,hidden:()=>s5,AccordionItem:()=>ef,dataGridRowTemplate:()=>tM,Radio:()=>i2,DelegatesARIAListbox:()=>tE,roleForMenuItem:()=>iH,inject:()=>D,sliderTemplate:()=>sv,startSlotTemplate:()=>p,Slider:()=>sy,switchTemplate:()=>sC,newInstanceForScope:()=>V,Card:()=>tm,DefaultResolver:()=>x,MenuItem:()=>iV,Registration:()=>et,HorizontalScroll:()=>i3,BreadcrumbItem:()=>eU,anchorTemplate:()=>ew,sliderLabelTemplate:()=>sc,forcedColorsStylesheetBehavior:()=>sQ,textFieldTemplate:()=>sP,Container:()=>O,Select:()=>sa,AccordionExpandMode:()=>ex,DefaultComponentPresentation:()=>eu,optional:()=>H,endTemplate:()=>m,DataGridCellTypes:()=>e7,lazy:()=>P,pickerListItemTemplate:()=>iM,calendarCellTemplate:()=>tl,skeletonTemplate:()=>sh,tabsTemplate:()=>sT,PickerMenu:()=>ix,FlipperDirection:()=>im,transient:()=>A,Checkbox:()=>tg,validateKey:()=>ei,toolbarTemplate:()=>sH,isTreeItemElement:()=>s_,FactoryImpl:()=>_,TextField:()=>iK,DataGridCell:()=>ts,tabPanelTemplate:()=>sI,MatchMediaBehavior:()=>sG,ComponentPresentation:()=>ec,SliderLabel:()=>sm,composedParent:()=>tH,Picker:()=>iS,DelegatesARIACombobox:()=>tA,DelegatesARIAButton:()=>e5,FoundationElementRegistry:()=>ev,Avatar:()=>eV,disclosureTemplate:()=>il,treeItemTemplate:()=>sj,CalendarTitleTemplate:()=>ta,menuTemplate:()=>iN,ARIAGlobalStatesAndProperties:()=>eI,Calendar:()=>e8,ElementDisambiguation:()=>t5,Tooltip:()=>sU,AnchoredRegion:()=>eD,dividerTemplate:()=>id,numberFieldTemplate:()=>iq,PickerList:()=>iI,newInstanceOf:()=>N,DividerRole:()=>iu,MatchMediaStyleSheetBehavior:()=>sY,Switch:()=>sw,buttonTemplate:()=>eK,pickerListTemplate:()=>iL,singleton:()=>L,DateFormatter:()=>e4,checkboxTemplate:()=>tv,tooltipTemplate:()=>sB,avatarTemplate:()=>ez,ServiceLocator:()=>T,lightModeStylesheetBehavior:()=>sJ,TabsOrientation:()=>sR,StartEnd:()=>c,DelegatesARIAToolbar:()=>sN,progressRingTemplate:()=>iQ,Tabs:()=>sD,Badge:()=>eB,BaseProgress:()=>iZ,selectTemplate:()=>sl,disabledCursor:()=>s1,calendarRowTemplate:()=>th,PickerMenuOption:()=>iw,DataGrid:()=>tn,PropertyStyleSheetBehavior:()=>s0,ContainerImpl:()=>Z,TooltipPosition:()=>sq,dataGridCellTemplate:()=>tP,Disclosure:()=>ih,FlyoutPosTopFill:()=>eM,endSlotTemplate:()=>u,Menu:()=>iB,ListboxOption:()=>tw,SliderMode:()=>sg,anchoredRegionTemplate:()=>eO,badgeTemplate:()=>eN,menuItemTemplate:()=>iz,progressTemplate:()=>iJ,CheckableFormAssociated:()=>eZ,accordionItemTemplate:()=>b,dialogTemplate:()=>ie,Button:()=>e1,DelegatesARIAListboxOption:()=>tI,treeViewTemplate:()=>sW,all:()=>M,MenuItemRole:()=>iP,RadioGroup:()=>i1,NumberField:()=>iY,TabPanel:()=>sk,DataGridRowTypes:()=>te,DesignSystem:()=>t9,TextFieldType:()=>i_,GenerateHeaderOptions:()=>e6,calendarTemplate:()=>tu,cardTemplate:()=>tp,Tab:()=>sO,SelectPosition:()=>tO,breadcrumbTemplate:()=>ej,Listbox:()=>tk,Accordion:()=>e$,display:()=>s4,Search:()=>si,flipperTemplate:()=>iv,FlyoutPosTop:()=>eA,getDirection:()=>eR,ContainerConfiguration:()=>$,horizontalScrollTemplate:()=>i9,noninteractiveCalendarTemplate:()=>tc,Dialog:()=>ii,comboboxTemplate:()=>tF,FlyoutPosBottomFill:()=>eP,textAreaTemplate:()=>sA,listboxTemplate:()=>iC,Breadcrumb:()=>e_,startTemplate:()=>v,DesignToken:()=>t1,PickerListItem:()=>iE,accordionTemplate:()=>eg,radioTemplate:()=>i5,searchTemplate:()=>i7,FlyoutPosTallest:()=>eL});var h,d=i(23453);class c{handleStartContentChange(){this.startContainer.classList.toggle("start",this.start.assignedNodes().length>0)}handleEndContentChange(){this.endContainer.classList.toggle("end",this.end.assignedNodes().length>0)}}let u=(e,t)=>(0,d.html)`
    <span
        part="end"
