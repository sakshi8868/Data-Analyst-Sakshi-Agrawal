"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["7177"], {
2996(module) {
...
53236(module, __unused_rspack_exports, __webpack_require__) {
 ...
 */
const config = __webpack_require__(2996);
const nativeExec = __webpack_require__(24877);
const regexp_tree_1 = __webpack_require__(64019);
...
12912(module, __unused_rspack_exports, __webpack_require__) {
...
limitations under the License.
*/
const implementation = __webpack_require__(53236);
const native = __webpack_require__(24877);
const getPolyfill = __webpack_require__(86561);
const shim = __webpack_require__(23023);
const config = __webpack_require__(2996);
...
86561(module, __unused_rspack_exports, __webpack_require__) {
...
23023(module, __unused_rspack_exports, __webpack_require__) {
...
50498(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
...
var compatTransforms = __webpack_require__(77382);
var _transform = __webpack_require__(14351);
...
77382(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
module.exports = {
  // "dotAll" `s` flag
  dotAll: __webpack_require__(29292),

  // Named capturing groups.
  namedCapturingGroups: __webpack_require__(69934),

  // `x` flag
  xFlag: __webpack_require__(7243)
};
...
88333(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
var DFAMinimizer = __webpack_require__(30838);

var _require = __webpack_require__(7753),
...
83666(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
var NFA = __webpack_require__(27321);
var DFA = __webpack_require__(88333);

var nfaFromRegExp = __webpack_require__(9826);
var builders = __webpack_require__(48424);
...
48424(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
var NFA = __webpack_require__(27321);
var NFAState = __webpack_require__(23213);
...
9826(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
var parser = __webpack_require__(95926);

var _require = __webpack_require__(48424),
    alt = _require.alt,
    char = _require.char,
    or = _require.or,
    rep = _require.rep,
...
23213(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
var State = __webpack_require__(17067);
...
27321(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
55684(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
var clone = __webpack_require__(7047);
var parser = __webpack_require__(95926);
var transform = __webpack_require__(14351);
var optimizationTransforms = __webpack_require__(30244);
...
7412(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
var NodePath = __webpack_require__(94151);

var _require = __webpack_require__(26090),
...
75385(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
30244(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
// \ud83d\ude80 -> \u{1f680}
['charSurrogatePairToSingleUnicode', __webpack_require__(41624)],

// \u0061 -> a
['charCodeToSimpleChar', __webpack_require__(44299)],

// /Aa/i -> /aa/i
['charCaseInsensitiveLowerCaseTransform', __webpack_require__(18126)],

// [\d\d] -> [\d]
['charClassRemoveDuplicates', __webpack_require__(14702)],

// a{1,2}a{2,3} -> a{3,5}
['quantifiersMerge', __webpack_require__(23921)],

// a{1,} -> a+, a{3,3} -> a{3}, a{1} -> a
['quantifierRangeToSymbol', __webpack_require__(47005)],

// [a-a] -> [a], [a-b] -> [ab]
['charClassClassrangesToChars', __webpack_require__(19637)],

// [0-9] -> [\d]
['charClassToMeta', __webpack_require__(33198)],

// [\d] -> \d, [^\w] -> \W
['charClassToSingleChar', __webpack_require__(5390)],

// \e -> e
['charEscapeUnescape', __webpack_require__(33108)],

// [a-de-f] -> [a-f]
['charClassClassrangesMerge', __webpack_require__(68768)],

// (ab|ab) -> (ab)
['disjunctionRemoveDuplicates', __webpack_require__(75385)],

// (a|b|c) -> [abc]
['groupSingleCharsToCharClass', __webpack_require__(24660)],

// (?:)a -> a
['removeEmptyGroup', __webpack_require__(11397)],

// (?:a) -> a
['ungroup', __webpack_require__(82215)],

// abcabcabc -> (?:abc){3}
['combineRepeatingPatterns', __webpack_require__(7412)]]);
...
23921(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
36076(module, __unused_rspack_exports, __webpack_require__) {
/**
 ...
 */
var yyleng = (/* unused pure expression or super */ null && (void 0));
...
var unicodeProperties = __webpack_require__(54243);
...
95926(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
var regexpTreeParser = __webpack_require__(36076);
...
67616(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
var compatTranspiler = __webpack_require__(50498);
var generator = __webpack_require__(96878);
var optimizer = __webpack_require__(55684);
var parser = __webpack_require__(95926);
var _transform = __webpack_require__(14351);
var _traverse = __webpack_require__(60111);
var fa = __webpack_require__(83666);

var _require = __webpack_require__(76117),
...
14351(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
var generator = __webpack_require__(96878);
var parser = __webpack_require__(95926);
var traverse = __webpack_require__(60111);
...
60111(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
64019(module, __unused_rspack_exports, __webpack_require__) {
/**
 * The MIT License (MIT)
 * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
 */
...
module.exports = __webpack_require__(67616);

},

}]);
//# sourceMappingURL=7177.9c4ebbb18ebee09b.js.map?v=9c4ebbb18ebee09b