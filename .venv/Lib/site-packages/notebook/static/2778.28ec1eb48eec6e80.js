"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["2778"], {
...
849(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
...
/* import */ var _chunk_55IACEB6_mjs__rspack_import_0 = __webpack_require__(62904);
/* import */ var _chunk_QN33PNHL_mjs__rspack_import_1 = __webpack_require__(67313);
/* import */ var _chunk_N4CR4FBY_mjs__rspack_import_2 = __webpack_require__(86528);
...
var getDir = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)(async function(text, id, _version, diag) {
  _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("REF0:");
  _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("Drawing state diagram (v2)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_ABZYJK2D_mjs__rspack_import_4/* .getConfig2 */.D7)();
  diag.db.extract(diag.db.getRootDocV2());
  const data4Layout = diag.db.getData();
  const svg = (0,_chunk_55IACEB6_mjs__rspack_import_0/* .getDiagramElement */.A)(id, securityLevel);
  ...
  await (0,_chunk_N4CR4FBY_mjs__rspack_import_2/* .render */.XX)(data4Layout, svg);
  const padding = 8;
  try {
    ...
    links.forEach((linkInfo, key) => {
      ...
      if (!stateId) {
        _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.warn */.Rm.warn("\u26A0\uFE0F Invalid or missing stateId from key:", JSON.stringify(key));
        return;
      }
      ...
      if (!matchedElem) {
        _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.warn */.Rm.warn("\u26A0\uFE0F Could not find node matching text:", stateId);
        return;
      }
      const parent = matchedElem.parentNode;
      if (!parent) {
        _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.warn */.Rm.warn("\u26A0\uFE0F Node has no parent, cannot wrap:", stateId);
        return;
      }
      ...
      _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("\u{1F517} Wrapped node in <a> tag for:", stateId, linkInfo.url);
    });
  } catch (err) {
    _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.error */.Rm.error("\u274C Error injecting clickable links:", err);
  }
  _chunk_S3R3BYOJ_mjs__rspack_import_3/* .utils_default.insertTitle */._K.insertTitle(
    svg,
    "statediagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_QN33PNHL_mjs__rspack_import_1/* .setupViewPortForSVG */.P)(svg, padding, CSS_DIAGRAM, conf?.useMaxWidth ?? true);
}, "draw");
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)(stateDomId, "stateDomId");
var setupDoc = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)((parentParsedItem, doc, diagramStates, nodes, edges, altFlag, look, classes) => {
  _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.trace */.Rm.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case STMT_STATE:
      ...
      case STMT_RELATION:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _chunk_ABZYJK2D_mjs__rspack_import_4/* .common_default.sanitizeText */.Y2.sanitizeText(item.description ?? "", (0,_chunk_ABZYJK2D_mjs__rspack_import_4/* .getConfig2 */.D7)()),
...
var getDir2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
    for (const parsedItemDoc of parsedItem.doc) {
      if (parsedItemDoc.stmt === "dir") {
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)(insertOrUpdateNode, "insertOrUpdateNode");
function getClassesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.classes?.join(" ") ?? "";
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)(getClassesFromDbInfo, "getClassesFromDbInfo");
function getStylesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.styles ?? [];
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)(getStylesFromDbInfo, "getStylesFromDbInfo");
var dataFetcher = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)((parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
  const itemId = parsedItem.id;
  const dbState = diagramStates.get(itemId);
  const classStr = getClassesFromDbInfo(dbState);
  const style = getStylesFromDbInfo(dbState);
  const config = (0,_chunk_ABZYJK2D_mjs__rspack_import_4/* .getConfig2 */.D7)();
  _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("dataFetcher parsedItem", parsedItem, dbState, style);
  if (itemId !== "root") {
    ...
    if (!nodeDb.get(itemId)) {
      nodeDb.set(itemId, {
        id: itemId,
        shape,
        description: _chunk_ABZYJK2D_mjs__rspack_import_4/* .common_default.sanitizeText */.Y2.sanitizeText(itemId, config),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _chunk_ABZYJK2D_mjs__rspack_import_4/* .common_default.sanitizeTextOrArray */.Y2.sanitizeTextOrArray(newNode.description, config);
    }
    ...
    if (!newNode.type && parsedItem.doc) {
      _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("Setting cluster for XCX", itemId, getDir2(parsedItem));
      newNode.type = "group";
    ...
    if (parent && parent.id !== "root") {
      _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.trace */.Rm.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
  ...
  if (parsedItem.doc) {
    _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.trace */.Rm.trace("Adding nodes children ");
    setupDoc(parsedItem, parsedItem.doc, diagramStates, nodes, edges, !altFlag, look, classes);
  }
}, "dataFetcher");
var reset = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)(() => {
  nodeDb.clear();
  graphItemCount = 0;
}, "reset");
...
var newClassesList = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)(() => /* @__PURE__ */ new Map(), "newClassesList");
var newDoc = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)(() => ({
  relations: [],
  states: /* @__PURE__ */ new Map(),
  documents: {}
}), "newDoc");
var clone = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)((o) => JSON.parse(JSON.stringify(o)), "clone");
var StateDB = class {
  constructor(version) {
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)(this, "StateDB");
  }
  static {
    this.relationType = {
      AGGREGATION: 0,
  ...
  setRootDoc(o) {
    _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("Setting root doc", o);
    this.rootDoc = o;
    if (this.version === 1) {
      this.extract(o);
    } else {
  ...
  docTranslator(parent, node, first) {
    ...
    if (doc.length > 0 && currentDoc.length > 0) {
      const newNode = {
        stmt: STMT_STATE,
        id: (0,_chunk_S3R3BYOJ_mjs__rspack_import_3/* .generateId */.$C)(),
        type: "divider",
  ...
  addState(id, type = DEFAULT_STATE_TYPE, doc = void 0, descr = void 0, note = void 0, classes = void 0, styles = void 0, textStyles = void 0) {
    ...
    if (!this.currentDocument.states.has(trimmedId)) {
      _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("Adding state ", trimmedId, descr);
    ...
    if (descr) {
      _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("Setting state description", trimmedId, descr);
    ...
    if (note) {
      ...
      doc2.note = note;
      doc2.note.text = _chunk_ABZYJK2D_mjs__rspack_import_4/* .common_default.sanitizeText */.Y2.sanitizeText(doc2.note.text, (0,_chunk_ABZYJK2D_mjs__rspack_import_4/* .getConfig2 */.D7)());
    }
    if (classes) {
      _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("Setting state classes", trimmedId, classes);
    ...
    if (styles) {
      _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("Setting state styles", trimmedId, styles);
  ...
  logDocuments() {
    _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.info */.Rm.info("Documents = ", this.documents);
  }
  getRelations() {
  ...
  addLink(stateId, url, tooltip) {
    ...
    _chunk_AGHRB4JF_mjs__rspack_import_5/* .log.warn */.Rm.warn("Adding link", stateId, url, tooltip);
  }
  /**
  ...
  addRelationObjs(item1, item2, relationTitle = "") {
    ...
    this.currentDocument.relations.push({
      id1,
      id2,
      relationTitle: _chunk_ABZYJK2D_mjs__rspack_import_4/* .common_default.sanitizeText */.Y2.sanitizeText(relationTitle, (0,_chunk_ABZYJK2D_mjs__rspack_import_4/* .getConfig2 */.D7)())
    });
  }
  /**
  ...
  addRelation(item1, item2, title) {
    if (typeof item1 === "object" && typeof item2 === "object") {
      ...
      this.currentDocument.relations.push({
        id1,
        id2,
        relationTitle: title ? _chunk_ABZYJK2D_mjs__rspack_import_4/* .common_default.sanitizeText */.Y2.sanitizeText(title, (0,_chunk_ABZYJK2D_mjs__rspack_import_4/* .getConfig2 */.D7)()) : void 0
      });
    }
  }
  addDescription(id, descr) {
    ...
    theState?.descriptions?.push(_chunk_ABZYJK2D_mjs__rspack_import_4/* .common_default.sanitizeText */.Y2.sanitizeText(_descr, (0,_chunk_ABZYJK2D_mjs__rspack_import_4/* .getConfig2 */.D7)()));
  }
  cleanupLabel(label) {
  ...
  getConfig() {
    return (0,_chunk_ABZYJK2D_mjs__rspack_import_4/* .getConfig2 */.D7)().state;
  }
};

// src/diagrams/state/styles.js
var getStyles = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_5/* .__name */.K2)((options) => `
...
//# sourceMappingURL=2778.28ec1eb48eec6e80.js.map?v=28ec1eb48eec6e80