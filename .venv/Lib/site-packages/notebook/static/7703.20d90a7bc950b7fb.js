(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["7703"], {
85674(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  ENUM_KEY: () => (/* reexport */ (/* inlined export .ENUM_KEY */"enum")),
  ...
  ONE_OF_KEY: () => (/* reexport */ (/* inlined export .ONE_OF_KEY */"oneOf")),
  ...
  CONST_KEY: () => (/* reexport */ (/* inlined export .CONST_KEY */"const")),
  ...
  NAME_KEY: () => (/* reexport */ (/* inlined export .NAME_KEY */"$name")),
  dataURItoBlob: () => (/* reexport */ dataURItoBlob),
  getSchemaType: () => (/* reexport */ getSchemaType),
  TranslatableString: () => (/* reexport */ enums_TranslatableString),
  ...
  ITEMS_KEY: () => (/* reexport */ (/* inlined export .ITEMS_KEY */"items")),
  ...
  ALL_OF_KEY: () => (/* reexport */ (/* inlined export .ALL_OF_KEY */"allOf")),
  helpId: () => (/* reexport */ helpId),
  isMultiSelect: () => (/* reexport */ isMultiSelect),
  isSelect: () => (/* reexport */ isSelect),
  REF_KEY: () => (/* reexport */ (/* inlined export .REF_KEY */"$ref")),
  ...
  ANY_OF_KEY: () => (/* reexport */ (/* inlined export .ANY_OF_KEY */"anyOf")),
  ...
  IF_KEY: () => (/* reexport */ (/* inlined export .IF_KEY */"if")),
  ...
  ID_KEY: () => (/* reexport */ (/* inlined export .ID_KEY */"$id")),
...
var isEqualWith = __webpack_require__(34336);
...
var jsonpointer = __webpack_require__(63451);
...
function findSchemaDefinition($ref, rootSchema = {}) {
    ...
    if (current[(/* inlined export .REF_KEY */"$ref")]) {
        const [remaining, theRef] = splitKeyElementFromObject((/* inlined export .REF_KEY */"$ref"), current);
...
var union = __webpack_require__(68535);
...
function resolveSchema(validator, schema, rootSchema, expandAllBranches, recurseList, formData) {
    ...
    if ((/* inlined export .ALL_OF_KEY */"allOf") in schema && Array.isArray(schema.allOf)) {
...
function resolveAllReferences(schema, rootSchema, recurseList) {
    ...
    if ((/* inlined export .REF_KEY */"$ref") in resolvedSchema) {
    ...
    if ((/* inlined export .ITEMS_KEY */"items") in resolvedSchema &&
...
function stubExistingAdditionalProperties(validator, theSchema, rootSchema, aFormData) {
    ...
    Object.keys(formData).forEach((key) => {
        ...
        if (typeof schema.additionalProperties !== 'boolean') {
            if ((/* inlined export .REF_KEY */"$ref") in schema.additionalProperties) {
                additionalProperties = retrieveSchema(validator, { $ref: get_default()(schema.additionalProperties, [(/* inlined export .REF_KEY */"$ref")]) }, rootSchema, formData);
            }
            else if ('type' in schema.additionalProperties) {
                additionalProperties = { ...schema.additionalProperties };
            }
            else if ((/* inlined export .ANY_OF_KEY */"anyOf") in schema.additionalProperties || (/* inlined export .ONE_OF_KEY */"oneOf") in schema.additionalProperties) {
...
function withDependentSchema(validator, schema, rootSchema, dependencyKey, dependencyValue, expandAllBranches, recurseList, formData) {
    ...
    return dependentSchemas.flatMap((dependent) => {
        ...
        const resolvedOneOfs = oneOf.map((subschema) => {
            if (typeof subschema === 'boolean' || !((/* inlined export .REF_KEY */"$ref") in subschema)) {
                return [subschema];
            }
    ...
    if (schema) {
        if (isObject_default()(schema.properties)) {
            totalScore += reduce_default()(schema.properties, (score, value, key) => {
                ...
                if (has_default()(value, (/* inlined export .REF_KEY */"$ref"))) {
                    const newSchema = retrieveSchema(validator, value, rootSchema, formValue);
                    return score + calculateIndexScore(validator, rootSchema, newSchema, formValue || {});
                }
                if ((has_default()(value, (/* inlined export .ONE_OF_KEY */"oneOf")) || has_default()(value, (/* inlined export .ANY_OF_KEY */"anyOf"))) && formValue) {
                    const key = has_default()(value, (/* inlined export .ONE_OF_KEY */"oneOf")) ? (/* inlined export .ONE_OF_KEY */"oneOf") : (/* inlined export .ANY_OF_KEY */"anyOf");
...
function isConstant(schema) {
    return (Array.isArray(schema.enum) && schema.enum.length === 1) || (/* inlined export .CONST_KEY */"const") in schema;
}
 ...
 */
var getDefaultFormState_AdditionalItemsHandling;
...
})(getDefaultFormState_AdditionalItemsHandling || (getDefaultFormState_AdditionalItemsHandling = {}));
 ...
 */
function getInnerSchemaForArrayItem(schema, additionalItems = getDefaultFormState_AdditionalItemsHandling.Ignore, idx = -1) {
    if (idx >= 0) {
    ...
    if (additionalItems !== getDefaultFormState_AdditionalItemsHandling.Ignore && isObject(schema.additionalItems)) {
...
function computeDefaults(validator, rawSchema, { parentDefaults, rawFormData, rootSchema = {}, includeUndefinedValues = false, _recurseList = [], experimental_defaultFormStateBehavior = undefined, required, } = {}) {
    ...
    else if ((/* inlined export .REF_KEY */"$ref") in schema) {
        const refName = schema[(/* inlined export .REF_KEY */"$ref")];
    ...
    else if ((/* inlined export .ONE_OF_KEY */"oneOf") in schema) {
    ...
    else if ((/* inlined export .ANY_OF_KEY */"anyOf") in schema) {
    ...
    switch (getSchemaType(schema)) {
        ...
        case 'object': {
            ...
            const retrievedSchema = (experimental_defaultFormStateBehavior === null || experimental_defaultFormStateBehavior === void 0 ? void 0 : experimental_defaultFormStateBehavior.allOf) === 'populateDefaults' && (/* inlined export .ALL_OF_KEY */"allOf") in schema
        ...
        case 'array': {
            ...
            if (Array.isArray(defaults)) {
                defaults = defaults.map((item, idx) => {
                    const schemaItem = getInnerSchemaForArrayItem(schema, getDefaultFormState_AdditionalItemsHandling.Fallback, idx);
            ...
            const fillerSchema = getInnerSchemaForArrayItem(schema, getDefaultFormState_AdditionalItemsHandling.Invert);
...
function sanitizeDataForNewSchema(validator, rootSchema, newSchema, oldSchema, data = {}) {
    ...
    if (has_default()(newSchema, PROPERTIES_KEY)) {
        ...
        keys.forEach((key) => {
            ...
            if (has_default()(oldKeyedSchema, (/* inlined export .REF_KEY */"$ref"))) {
                oldKeyedSchema = retrieveSchema(validator, oldKeyedSchema, rootSchema, formValue);
            }
            if (has_default()(newKeyedSchema, (/* inlined export .REF_KEY */"$ref"))) {
        ...
        if (typeof oldSchemaItems === 'object' &&
            ...
            if (has_default()(oldSchemaItems, (/* inlined export .REF_KEY */"$ref"))) {
                oldSchemaItems = retrieveSchema(validator, oldSchemaItems, rootSchema, data);
            }
            if (has_default()(newSchemaItems, (/* inlined export .REF_KEY */"$ref"))) {
...
function toIdSchemaInternal(validator, schema, idPrefix, idSeparator, id, rootSchema, formData, _recurseList = []) {
    if ((/* inlined export .REF_KEY */"$ref") in schema || DEPENDENCIES_KEY in schema || (/* inlined export .ALL_OF_KEY */"allOf") in schema) {
    ...
    if ((/* inlined export .ITEMS_KEY */"items") in schema && !get_default()(schema, [(/* inlined export .ITEMS_KEY */"items"), (/* inlined export .REF_KEY */"$ref")])) {
        return toIdSchemaInternal(validator, get_default()(schema, (/* inlined export .ITEMS_KEY */"items")), idPrefix, idSeparator, id, rootSchema, formData, _recurseList);
    }
    ...
    if (getSchemaType(schema) === 'object' && PROPERTIES_KEY in schema) {
        for (const name in schema.properties) {
            ...
            const fieldId = idSchema[(/* inlined export .ID_KEY */"$id")] + idSeparator + name;
...
function toPathSchemaInternal(validator, schema, name, rootSchema, formData, _recurseList = []) {
    ...
    let pathSchema = {
        [(/* inlined export .NAME_KEY */"$name")]: name.replace(/^\./, ''),
    };
    if ((/* inlined export .ONE_OF_KEY */"oneOf") in schema || (/* inlined export .ANY_OF_KEY */"anyOf") in schema) {
        const xxxOf = (/* inlined export .ONE_OF_KEY */"oneOf") in schema ? schema.oneOf : schema.anyOf;
        const discriminator = getDiscriminatorFieldFromSchema(schema);
    ...
    if ((/* inlined export .ITEMS_KEY */"items") in schema && Array.isArray(formData)) {
...
var isNil = __webpack_require__(3583);
...
var react_is = __webpack_require__(84271);
...
function idGenerator(id, suffix) {
    const theId = isString_default()(id) ? id : id[(/* inlined export .ID_KEY */"$id")];
...
function toConstant(schema) {
    if ((/* inlined export .ENUM_KEY */"enum") in schema && Array.isArray(schema.enum) && schema.enum.length === 1) {
        return schema.enum[0];
    }
    if ((/* inlined export .CONST_KEY */"const") in schema) {
        return schema.const;
    }
...
function withIdRefPrefixObject(node) {
    for (const key in node) {
        ...
        if (key === (/* inlined export .REF_KEY */"$ref") && typeof value === 'string' && value.startsWith('#')) {
...
})(enums_TranslatableString || (enums_TranslatableString = {}));
//# sourceMappingURL=enums.js.map
// EXTERNAL MODULE: ../node_modules/lodash/forEach.js
var forEach = __webpack_require__(45390);
...
class ParserValidator {
    ...
    addSchema(schema, hash) {
        const key = get_default()(schema, (/* inlined export .ID_KEY */"$id"), hash);
        const identifiedSchema = { ...schema, [(/* inlined export .ID_KEY */"$id")]: key };
...
function parseSchema(validator, recurseList, rootSchema, schema) {
    ...
    schemas.forEach((schema) => {
        ...
        if (sameSchemaIndex === -1) {
            ...
            if ((/* inlined export .ITEMS_KEY */"items") in schema && !Array.isArray(schema.items) && typeof schema.items !== 'boolean') {
...
6565(module, __unused_rspack_exports, __webpack_require__) {
"use strict";


// MODULES //

var isArray = __webpack_require__( 47023 ),
	isIntegerArray = __webpack_require__( 63356 ),
	isFunction = __webpack_require__( 32950 );
...
61959(module, __unused_rspack_exports, __webpack_require__) {
"use strict";


// MODULES //

var gcd = __webpack_require__( 6565 ),
	isArray = __webpack_require__( 47023 ),
	isIntegerArray = __webpack_require__( 63356 ),
	isFunction = __webpack_require__( 32950 );
...
2070(module, __unused_rspack_exports, __webpack_require__) {
var isEqual = __webpack_require__(18264)
var sortBy = __webpack_require__(1883)
var uniq = __webpack_require__(13459)
var uniqWith = __webpack_require__(90475)
var defaults = __webpack_require__(93936)
var intersectionWith = __webpack_require__(79096)
var isPlainObject = __webpack_require__(54679)
var isBoolean = __webpack_require__(88552)
...
29073(module, __unused_rspack_exports, __webpack_require__) {
const flatten = __webpack_require__(73406)
const flattenDeep = __webpack_require__(35724)
const isPlainObject = __webpack_require__(54679)
const uniq = __webpack_require__(13459)
const uniqWith = __webpack_require__(90475)
const without = __webpack_require__(42644)
...
4375(module, __unused_rspack_exports, __webpack_require__) {

const compare = __webpack_require__(2070)
const forEach = __webpack_require__(45390)
const {
  allUniqueKeys,
  deleteUndefinedProps,
  has,
...
32706(module, __unused_rspack_exports, __webpack_require__) {
...
37342(module, __unused_rspack_exports, __webpack_require__) {
const cloneDeep = __webpack_require__(1419)
const compare = __webpack_require__(2070)
const computeLcm = __webpack_require__(61959)
const defaultsDeep = __webpack_require__(44526)
const flatten = __webpack_require__(73406)
const flattenDeep = __webpack_require__(35724)
const intersection = __webpack_require__(39155)
const intersectionWith = __webpack_require__(79096)
const isEqual = __webpack_require__(18264)
const isPlainObject = __webpack_require__(54679)
const pullAll = __webpack_require__(93578)
const sortBy = __webpack_require__(1883)
const uniq = __webpack_require__(13459)
const uniqWith = __webpack_require__(90475)

const propertiesResolver = __webpack_require__(32706)
const itemsResolver = __webpack_require__(4375)
...
63451(__unused_rspack_module, exports) {
var hasExcape = /~/
...
12769(module, __unused_rspack_exports, __webpack_require__) {
var baseIndexOf = __webpack_require__(4575);
...
61617(module, __unused_rspack_exports, __webpack_require__) {
...
70351(module, __unused_rspack_exports, __webpack_require__) {
...
72305(module, __unused_rspack_exports, __webpack_require__) {
var baseForOwn = __webpack_require__(61701),
    createBaseEach = __webpack_require__(42965);
...
61469(module, __unused_rspack_exports, __webpack_require__) {
var createBaseFor = __webpack_require__(15409);
...
61701(module, __unused_rspack_exports, __webpack_require__) {
var baseFor = __webpack_require__(61469),
...
4575(module, __unused_rspack_exports, __webpack_require__) {
...
84229(module, __unused_rspack_exports, __webpack_require__) {
var SetCache = __webpack_require__(61527),
    arrayIncludes = __webpack_require__(12769),
    arrayIncludesWith = __webpack_require__(60021),
    arrayMap = __webpack_require__(44272),
...
72491(module, __unused_rspack_exports, __webpack_require__) {
var Stack = __webpack_require__(86469),
    baseIsEqual = __webpack_require__(22122);
...
31454(module, __unused_rspack_exports, __webpack_require__) {
var baseMatches = __webpack_require__(68171),
    baseMatchesProperty = __webpack_require__(37182),
    identity = __webpack_require__(74796),
    isArray = __webpack_require__(6397),
    property = __webpack_require__(75795);
...
23892(module, __unused_rspack_exports, __webpack_require__) {
var baseEach = __webpack_require__(72305),
...
68171(module, __unused_rspack_exports, __webpack_require__) {
var baseIsMatch = __webpack_require__(72491),
    getMatchData = __webpack_require__(77924),
    matchesStrictComparable = __webpack_require__(43729);
...
37182(module, __unused_rspack_exports, __webpack_require__) {
var baseIsEqual = __webpack_require__(22122),
    get = __webpack_require__(62832),
    hasIn = __webpack_require__(98235),
    isKey = __webpack_require__(13726),
    isStrictComparable = __webpack_require__(23048),
    matchesStrictComparable = __webpack_require__(43729),
...
99702(module, __unused_rspack_exports, __webpack_require__) {
var Stack = __webpack_require__(86469),
    assignMergeValue = __webpack_require__(61617),
    baseFor = __webpack_require__(61469),
    baseMergeDeep = __webpack_require__(80708),
    isObject = __webpack_require__(58953),
    keysIn = __webpack_require__(15405),
    safeGet = __webpack_require__(29874);
...
80708(module, __unused_rspack_exports, __webpack_require__) {
var assignMergeValue = __webpack_require__(61617),
    ...
    isArray = __webpack_require__(6397),
    isArrayLikeObject = __webpack_require__(75569),
    isBuffer = __webpack_require__(30492),
    isFunction = __webpack_require__(18446),
    isObject = __webpack_require__(58953),
    isPlainObject = __webpack_require__(54679),
    isTypedArray = __webpack_require__(70376),
    safeGet = __webpack_require__(29874),
    toPlainObject = __webpack_require__(47264);
...
54183(module, __unused_rspack_exports, __webpack_require__) {
var arrayMap = __webpack_require__(44272),
    baseGet = __webpack_require__(17722),
    baseIteratee = __webpack_require__(31454),
    baseMap = __webpack_require__(23892),
    baseSortBy = __webpack_require__(75069),
    baseUnary = __webpack_require__(30041),
    compareMultiple = __webpack_require__(51366),
    identity = __webpack_require__(74796),
    isArray = __webpack_require__(6397);
...
75267(module, __unused_rspack_exports, __webpack_require__) {
...
67904(module, __unused_rspack_exports, __webpack_require__) {
var arrayMap = __webpack_require__(44272),
    baseIndexOf = __webpack_require__(4575),
    baseIndexOfWith = __webpack_require__(38327),
    baseUnary = __webpack_require__(30041),
    copyArray = __webpack_require__(68835);
...
71506(module, __unused_rspack_exports, __webpack_require__) {
var identity = __webpack_require__(74796),
...
68812(module, __unused_rspack_exports, __webpack_require__) {
...
18881(module, __unused_rspack_exports, __webpack_require__) {
var SetCache = __webpack_require__(61527),
    arrayIncludes = __webpack_require__(12769),
    arrayIncludesWith = __webpack_require__(60021),
    cacheHas = __webpack_require__(79151),
...
70257(module, __unused_rspack_exports, __webpack_require__) {
var isArrayLikeObject = __webpack_require__(75569);
...
94702(module, __unused_rspack_exports, __webpack_require__) {
var identity = __webpack_require__(74796);
...
37414(module, __unused_rspack_exports, __webpack_require__) {
...
51366(module, __unused_rspack_exports, __webpack_require__) {
var compareAscending = __webpack_require__(37414);
...
54171(module, __unused_rspack_exports, __webpack_require__) {
var baseRest = __webpack_require__(71506),
...
42965(module, __unused_rspack_exports, __webpack_require__) {
var isArrayLike = __webpack_require__(18330);
...
34953(module, __unused_rspack_exports, __webpack_require__) {
var Set = __webpack_require__(60157),
...
69386(module, __unused_rspack_exports, __webpack_require__) {
var baseMerge = __webpack_require__(99702),
    isObject = __webpack_require__(58953);
...
77924(module, __unused_rspack_exports, __webpack_require__) {
var isStrictComparable = __webpack_require__(23048),
    keys = __webpack_require__(31178);
...
66220(module, __unused_rspack_exports, __webpack_require__) {
...
23048(module, __unused_rspack_exports, __webpack_require__) {
...
93936(module, __unused_rspack_exports, __webpack_require__) {
var baseRest = __webpack_require__(71506),
    eq = __webpack_require__(39316),
    isIterateeCall = __webpack_require__(66220),
    keysIn = __webpack_require__(15405);
...
44526(module, __unused_rspack_exports, __webpack_require__) {
var apply = __webpack_require__(96701),
    baseRest = __webpack_require__(71506),
    customDefaultsMerge = __webpack_require__(69386),
    mergeWith = __webpack_require__(89032);
...
35724(module, __unused_rspack_exports, __webpack_require__) {
...
45390(module, __unused_rspack_exports, __webpack_require__) {
var arrayEach = __webpack_require__(10149),
    baseEach = __webpack_require__(72305),
...
39155(module, __unused_rspack_exports, __webpack_require__) {
var arrayMap = __webpack_require__(44272),
    baseIntersection = __webpack_require__(84229),
    baseRest = __webpack_require__(71506),
    castArrayLikeObject = __webpack_require__(70257);
...
79096(module, __unused_rspack_exports, __webpack_require__) {
var arrayMap = __webpack_require__(44272),
    baseIntersection = __webpack_require__(84229),
    baseRest = __webpack_require__(71506),
    castArrayLikeObject = __webpack_require__(70257),
...
75569(module, __unused_rspack_exports, __webpack_require__) {
var isArrayLike = __webpack_require__(18330),
    isObjectLike = __webpack_require__(22934);
...
88552(module, __unused_rspack_exports, __webpack_require__) {
...
34336(module, __unused_rspack_exports, __webpack_require__) {
var baseIsEqual = __webpack_require__(22122);
...
37531(module, __unused_rspack_exports, __webpack_require__) {
var baseGetTag = __webpack_require__(87148),
    isObjectLike = __webpack_require__(22934);
...
7571(module, __unused_rspack_exports, __webpack_require__) {
var baseGetTag = __webpack_require__(87148),
    isArray = __webpack_require__(6397),
    isObjectLike = __webpack_require__(22934);
...
25632(module, __unused_rspack_exports, __webpack_require__) {
var baseMerge = __webpack_require__(99702),
    createAssigner = __webpack_require__(54171);
...
89032(module, __unused_rspack_exports, __webpack_require__) {
var baseMerge = __webpack_require__(99702),
    createAssigner = __webpack_require__(54171);
...
75795(module, __unused_rspack_exports, __webpack_require__) {
var baseProperty = __webpack_require__(93305),
    basePropertyDeep = __webpack_require__(75267),
    isKey = __webpack_require__(13726),
    toKey = __webpack_require__(86729);
...
93578(module, __unused_rspack_exports, __webpack_require__) {
var basePullAll = __webpack_require__(67904);
...
7168(module, __unused_rspack_exports, __webpack_require__) {
var arrayReduce = __webpack_require__(42814),
    baseEach = __webpack_require__(72305),
    baseIteratee = __webpack_require__(31454),
    baseReduce = __webpack_require__(42226),
    isArray = __webpack_require__(6397);
...
1883(module, __unused_rspack_exports, __webpack_require__) {
var baseFlatten = __webpack_require__(61044),
...
99506(module, __unused_rspack_exports, __webpack_require__) {
var baseTimes = __webpack_require__(36204),
    castFunction = __webpack_require__(94702),
    toInteger = __webpack_require__(79445);
...
14764(module, __unused_rspack_exports, __webpack_require__) {
var toNumber = __webpack_require__(95378);
...
79445(module, __unused_rspack_exports, __webpack_require__) {
var toFinite = __webpack_require__(14764);
...
95378(module, __unused_rspack_exports, __webpack_require__) {
...
47264(module, __unused_rspack_exports, __webpack_require__) {
...
69740(module, __unused_rspack_exports, __webpack_require__) {
var arrayEach = __webpack_require__(10149),
    baseCreate = __webpack_require__(23508),
    baseForOwn = __webpack_require__(61701),
    baseIteratee = __webpack_require__(31454),
...
68535(module, __unused_rspack_exports, __webpack_require__) {
var baseFlatten = __webpack_require__(61044),
    baseRest = __webpack_require__(71506),
    baseUniq = __webpack_require__(18881),
    isArrayLikeObject = __webpack_require__(75569);
...
13459(module, __unused_rspack_exports, __webpack_require__) {
var baseUniq = __webpack_require__(18881);
...
90475(module, __unused_rspack_exports, __webpack_require__) {
var baseUniq = __webpack_require__(18881);
...
42644(module, __unused_rspack_exports, __webpack_require__) {
var baseDifference = __webpack_require__(70351),
    baseRest = __webpack_require__(71506),
    isArrayLikeObject = __webpack_require__(75569);
...
38299(__unused_rspack_module, exports) {
"use strict";
/**
 * @license React
...
84271(module, __unused_rspack_exports, __webpack_require__) {
"use strict";
...
63356(module, __unused_rspack_exports, __webpack_require__) {
"use strict";
/**
*
...
var isArray = __webpack_require__( 47023 ),
	isInteger = __webpack_require__( 5488 );
...
5488(module, __unused_rspack_exports, __webpack_require__) {
"use strict";
/**
*
*	VALIDATE: integer
...
var isNumber = __webpack_require__( 19931 );
...
//# sourceMappingURL=7703.20d90a7bc950b7fb.js.map?v=20d90a7bc950b7fb