"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["7693"], {
52348(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  diagram: () => (diagram)
});
/* import */ var _chunk_EXTU4WIE_mjs__rspack_import_0 = __webpack_require__(26859);
/* import */ var _chunk_JA3XYJ7Z_mjs__rspack_import_1 = __webpack_require__(28954);
/* import */ var _chunk_S3R3BYOJ_mjs__rspack_import_2 = __webpack_require__(26391);
/* import */ var _chunk_ABZYJK2D_mjs__rspack_import_3 = __webpack_require__(21065);
/* import */ var _chunk_AGHRB4JF_mjs__rspack_import_4 = __webpack_require__(87724);
/* import */ var d3__rspack_import_5 = __webpack_require__(38646);
...
var parser = (function() {
  var o = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 5:
          yy.setOrientation($$[$0]);
    ...
    parseError: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function parse(input) {
      ...
      (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ (function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: { "case-insensitive": true },
      performAction: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(Parser, "Parser");
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(isBarPlot, "isBarPlot");
function isBandAxisData(data) {
  return data.type === "band";
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(isBandAxisData, "isBandAxisData");
function isLinearAxisData(data) {
  return data.type === "linear";
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(isLinearAxisData, "isLinearAxisData");
...
var TextDimensionCalculatorWithFont = class {
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(this, "TextDimensionCalculatorWithFont");
  }
  getMaxDimension(texts, fontSize) {
    ...
    for (const t of texts) {
      const bbox = (0,_chunk_JA3XYJ7Z_mjs__rspack_import_1/* .computeDimensionOfText */.W6)(elem, 1, t);
...
var BaseAxis = class {
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(this, "BaseAxis");
  }
  setRange(range) {
    this.range = range;
...
var BandAxis = class extends BaseAxis {
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(this, "BandAxis");
  }
  constructor(axisConfig, axisThemeConfig, categories, title, textDimensionCalculator) {
    super(axisConfig, title, textDimensionCalculator, axisThemeConfig);
    this.categories = categories;
    this.scale = (0,d3__rspack_import_5/* .scaleBand */.WH)().domain(this.categories).range(this.getRange());
  }
  setRange(range) {
    super.setRange(range);
  }
  recalculateScale() {
    this.scale = (0,d3__rspack_import_5/* .scaleBand */.WH)().domain(this.categories).range(this.getRange()).paddingInner(1).paddingOuter(0).align(0.5);
    _chunk_AGHRB4JF_mjs__rspack_import_4/* .log.trace */.Rm.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
  }
  getTickValues() {
...
var LinearAxis = class extends BaseAxis {
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(this, "LinearAxis");
  }
  constructor(axisConfig, axisThemeConfig, domain, title, textDimensionCalculator) {
    super(axisConfig, title, textDimensionCalculator, axisThemeConfig);
    this.domain = domain;
    this.scale = (0,d3__rspack_import_5/* .scaleLinear */.m4Y)().domain(this.domain).range(this.getRange());
  }
  getTickValues() {
  ...
  recalculateScale() {
    ...
    this.scale = (0,d3__rspack_import_5/* .scaleLinear */.m4Y)().domain(domain).range(this.getRange());
  }
  getScaleValue(value) {
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getAxis, "getAxis");
...
var ChartTitle = class {
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(this, "ChartTitle");
  }
  setBoundingBoxXY(point) {
    this.boundingRect.x = point.x;
    this.boundingRect.y = point.y;
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getChartTitleComponent, "getChartTitleComponent");
...
var LinePlot = class {
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(this, "LinePlot");
  }
  getDrawableElement() {
    ...
    if (this.orientation === "horizontal") {
      path = (0,d3__rspack_import_5/* .line */.n8j)().y((d) => d[0]).x((d) => d[1])(finalData);
    } else {
      path = (0,d3__rspack_import_5/* .line */.n8j)().x((d) => d[0]).y((d) => d[1])(finalData);
    }
    if (!path) {
      return [];
    }
...
var BarPlot = class {
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(this, "BarPlot");
  }
  getDrawableElement() {
...
var BasePlot = class {
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(this, "BasePlot");
  }
  setAxes(xAxis, yAxis) {
    this.xAxis = xAxis;
    this.yAxis = yAxis;
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getPlotComponent, "getPlotComponent");
...
var Orchestrator = class {
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(this, "Orchestrator");
  }
...
var XYChartBuilder = class {
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(this, "XYChartBuilder");
  }
...
function getChartDefaultThemeConfig() {
  const defaultThemeVariables = (0,_chunk_ABZYJK2D_mjs__rspack_import_3/* .getThemeVariables */.P$)();
  const config = (0,_chunk_ABZYJK2D_mjs__rspack_import_3/* .getConfig */.zj)();
  return (0,_chunk_S3R3BYOJ_mjs__rspack_import_2/* .cleanAndMerge */.$t)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getChartDefaultThemeConfig, "getChartDefaultThemeConfig");
function getChartDefaultConfig() {
  const config = (0,_chunk_ABZYJK2D_mjs__rspack_import_3/* .getConfig */.zj)();
  return (0,_chunk_S3R3BYOJ_mjs__rspack_import_2/* .cleanAndMerge */.$t)(
    _chunk_ABZYJK2D_mjs__rspack_import_3/* .defaultConfig_default.xyChart */.UI.xyChart,
    config.xyChart
  );
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getChartDefaultConfig, "getChartDefaultConfig");
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getChartDefaultData, "getChartDefaultData");
function textSanitizer(text) {
  const config = (0,_chunk_ABZYJK2D_mjs__rspack_import_3/* .getConfig */.zj)();
  return (0,_chunk_ABZYJK2D_mjs__rspack_import_3/* .sanitizeText */.jZ)(text.trim(), config);
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(textSanitizer, "textSanitizer");
function setTmpSVGG(SVGG) {
  tmpSVGGroup = SVGG;
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(setTmpSVGG, "setTmpSVGG");
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(setOrientation, "setOrientation");
function setXAxisTitle(title) {
  xyChartData.xAxis.title = textSanitizer(title.text);
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(setXAxisTitle, "setXAxisTitle");
function setXAxisRangeData(min, max) {
  xyChartData.xAxis = { type: "linear", title: xyChartData.xAxis.title, min, max };
  hasSetXAxis = true;
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(setXAxisRangeData, "setXAxisRangeData");
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(setXAxisBand, "setXAxisBand");
function setYAxisTitle(title) {
  xyChartData.yAxis.title = textSanitizer(title.text);
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(setYAxisTitle, "setYAxisTitle");
function setYAxisRangeData(min, max) {
  xyChartData.yAxis = { type: "linear", title: xyChartData.yAxis.title, min, max };
  hasSetYAxis = true;
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(setYAxisRangeData, "setYAxisRangeData");
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(setYAxisRangeFromPlotData, "setYAxisRangeFromPlotData");
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(transformDataWithoutCategory, "transformDataWithoutCategory");
function getPlotColorFromPalette(plotIndex2) {
  return plotColorPalette[plotIndex2 === 0 ? 0 : plotIndex2 % plotColorPalette.length];
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getPlotColorFromPalette, "getPlotColorFromPalette");
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(setLineData, "setLineData");
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(setBarData, "setBarData");
function getDrawableElem() {
  if (xyChartData.plots.length === 0) {
    throw Error("No Plot to render, please provide a plot with some data");
  }
  xyChartData.title = (0,_chunk_ABZYJK2D_mjs__rspack_import_3/* .getDiagramTitle */.ab)();
  return XYChartBuilder.build(xyChartConfig, xyChartData, xyChartThemeConfig, tmpSVGGroup);
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getDrawableElem, "getDrawableElem");
function getChartThemeConfig() {
  return xyChartThemeConfig;
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getChartThemeConfig, "getChartThemeConfig");
function getChartConfig() {
  return xyChartConfig;
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getChartConfig, "getChartConfig");
function getXYChartData() {
  return xyChartData;
}
(0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getXYChartData, "getXYChartData");
var clear2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(function() {
  (0,_chunk_ABZYJK2D_mjs__rspack_import_3/* .clear */.IU)();
  plotIndex = 0;
...
var xychartDb_default = {
  getDrawableElem,
  clear: clear2,
  setAccTitle: _chunk_ABZYJK2D_mjs__rspack_import_3/* .setAccTitle */.SV,
  getAccTitle: _chunk_ABZYJK2D_mjs__rspack_import_3/* .getAccTitle */.iN,
  setDiagramTitle: _chunk_ABZYJK2D_mjs__rspack_import_3/* .setDiagramTitle */.ke,
  getDiagramTitle: _chunk_ABZYJK2D_mjs__rspack_import_3/* .getDiagramTitle */.ab,
  getAccDescription: _chunk_ABZYJK2D_mjs__rspack_import_3/* .getAccDescription */.m7,
  setAccDescription: _chunk_ABZYJK2D_mjs__rspack_import_3/* .setAccDescription */.EI,
  setOrientation,
  setXAxisTitle,
  setXAxisRangeData,
  setXAxisBand,
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)((txt, id, _version, diagObj) => {
  const db = diagObj.db;
  ...
  (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getDominantBaseLine, "getDominantBaseLine");
  function getTextAnchor(verticalPos) {
    return verticalPos === "left" ? "start" : verticalPos === "right" ? "end" : "middle";
  }
  (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getTextAnchor, "getTextAnchor");
  function getTextTransformation(data) {
    return `translate(${data.x}, ${data.y}) rotate(${data.rotation || 0})`;
  }
  (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getTextTransformation, "getTextTransformation");
  _chunk_AGHRB4JF_mjs__rspack_import_4/* .log.debug */.Rm.debug("Rendering xychart chart\n" + txt);
  ...
  (0,_chunk_ABZYJK2D_mjs__rspack_import_3/* .configureSvgSize */.a$)(svg, chartConfig.height, chartConfig.width, true);
  ...
  (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(getGroup, "getGroup");
      ...
      case "rect":
        ...
        if (chartConfig.showDataLabel) {
          if (chartConfig.chartOrientation === "horizontal") {
            ...
            (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(fitsHorizontally2, "fitsHorizontally");
            ...
            (0,_chunk_AGHRB4JF_mjs__rspack_import_4/* .__name */.K2)(fitsInBar2, "fitsInBar");
            const yOffset = 10;
            const validItems = shape.data.map((d, i) => ({ data: d, label: labelData[i].toString() })).filter((item) => item.data.width > 0 && item.data.height > 0);
            const candidateFontSizes = validItems.map((item) => {
              const { data, label } = item;
...
//# sourceMappingURL=7693.807bc5d00a514e7f.js.map?v=807bc5d00a514e7f