"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["7451"], {
39558(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
const newline = 10, carriageReturn = 13, dist_space = 32, tab = 9, hash = 35, parenOpen = 40, dot = 46,
...
const newlines = new dist/* .ExternalTokenizer */.Lu((input, stack) => {
  ...
  if (input.next < 0) {
    ...
    let spaces = 0;
    while (input.next == dist_space || input.next == tab) { input.advance(); spaces++; }
...
const indentation = new dist/* .ExternalTokenizer */.Lu((input, stack) => {
  ...
  if (prev == newline || prev == carriageReturn) {
    let depth = 0, chars = 0;
    for (;;) {
      if (input.next == dist_space) depth++;
...
const legacyPrint = new dist/* .ExternalTokenizer */.Lu(input => {
  ...
  for (let off = 0;; off++) {
    ...
    if (next == dist_space || next == tab) continue
...
//# sourceMappingURL=7451.7dda57c78dca3341.js.map?v=7dda57c78dca3341