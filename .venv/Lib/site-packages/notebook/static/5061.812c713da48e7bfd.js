...
23850(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_0/* .__name */.K2)(populateCommonDb, "populateCommonDb");
...
73396(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  diagram: () => (diagram)
});
...
/* import */ var _chunk_ATLVNIR6_mjs__rspack_import_2 = __webpack_require__(99010);
/* import */ var _chunk_4BX2VUAB_mjs__rspack_import_3 = __webpack_require__(23850);
...
/* import */ var _mermaid_js_parser__rspack_import_7 = __webpack_require__(11150);
...
var TreeMapDB = class {
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)(this, "TreeMapDB");
  }
  getNodes() {
    return this.nodes;
  }
  getConfig() {
    const defaultConfig = _chunk_ABZYJK2D_mjs__rspack_import_5/* .defaultConfig_default */.UI;
    const userConfig = (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig */.zj)();
    return (0,_chunk_S3R3BYOJ_mjs__rspack_import_4/* .cleanAndMerge */.$t)({
  ...
  addClass(id, _style) {
    ...
    if (styles) {
      styles.forEach((s) => {
        if ((0,_chunk_ATLVNIR6_mjs__rspack_import_2/* .isLabelStyle */.KX)(s)) {
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)(buildHierarchy, "buildHierarchy");

// src/diagrams/treemap/parser.ts
var populate = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((ast, db) => {
  (0,_chunk_4BX2VUAB_mjs__rspack_import_3/* .populateCommonDb */.S)(ast, db);
  const items = [];
  ...
  const addNodesRecursively = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((nodes, level) => {
...
var getItemName = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((item) => {
  return item.name ? String(item.name) : "";
}, "getItemName");
var parser = {
  // @ts-expect-error - TreeMapDB is not assignable to DiagramDB
  parser: { yy: void 0 },
  parse: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)(async (text) => {
    try {
      const parseFunc = _mermaid_js_parser__rspack_import_7/* .parse */.qg;
      const ast = await parseFunc("treemap", text);
      _chunk_AGHRB4JF_mjs__rspack_import_6/* .log.debug */.Rm.debug("Treemap AST:", ast);
      ...
      _chunk_AGHRB4JF_mjs__rspack_import_6/* .log.error */.Rm.error("Error parsing treemap:", error);
      throw error;
    }
  }, "parse")
};
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((_text, id, _version, diagram2) => {
  const treemapDb = diagram2.db;
  const config = treemapDb.getConfig();
  const treemapInnerPadding = config.padding ?? DEFAULT_INNER_PADDING;
  const title = treemapDb.getDiagramTitle();
  const root = treemapDb.getRoot();
  const { themeVariables } = (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig */.zj)();
  if (!root) {
    return;
  }
  ...
  (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .configureSvgSize */.a$)(svg, svgHeight, svgWidth, config.useMaxWidth);
  let valueFormat;
  try {
    const formatStr = config.valueFormat || ",";
    if (formatStr === "$0,0") {
      valueFormat = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((value) => "$" + (0,d3__rspack_import_8/* .format */.GPZ)(",")(value), "valueFormat");
    } else if (formatStr.startsWith("$") && formatStr.includes(",")) {
      const precision = /\.\d+/.exec(formatStr);
      const precisionStr = precision ? precision[0] : "";
      valueFormat = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((value) => "$" + (0,d3__rspack_import_8/* .format */.GPZ)("," + precisionStr)(value), "valueFormat");
    } else if (formatStr.startsWith("$")) {
      const restOfFormat = formatStr.substring(1);
      valueFormat = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((value) => "$" + (0,d3__rspack_import_8/* .format */.GPZ)(restOfFormat || "")(value), "valueFormat");
    } else {
      valueFormat = (0,d3__rspack_import_8/* .format */.GPZ)(formatStr);
    }
  } catch (error) {
    _chunk_AGHRB4JF_mjs__rspack_import_6/* .log.error */.Rm.error("Error creating format function:", error);
    valueFormat = (0,d3__rspack_import_8/* .format */.GPZ)(",");
  }
  const colorScale = (0,d3__rspack_import_8/* .scaleOrdinal */.UMr)().range([
    "transparent",
  ...
  const colorScalePeer = (0,d3__rspack_import_8/* .scaleOrdinal */.UMr)().range([
    "transparent",
  ...
  const colorScaleLabel = (0,d3__rspack_import_8/* .scaleOrdinal */.UMr)().range([
  ...
  const hierarchyRoot = (0,d3__rspack_import_8/* .hierarchy */.Sk5)(root).sum((d) => d.value ?? 0).sort((a, b) => (b.value ?? 0) - (a.value ?? 0));
  const treemapLayout = (0,d3__rspack_import_8/* .treemap */.hkb)().size([width, height]).paddingTop(
  ...
  sections.append("rect").attr("width", (d) => d.x1 - d.x0).attr("height", (d) => d.y1 - d.y0).attr("class", (_d, i) => {
    ...
    const styles = (0,_chunk_ATLVNIR6_mjs__rspack_import_2/* .styles2String */.GX)({ cssCompiledStyles: d.data.cssCompiledStyles });
  ...
  sections.append("text").attr("class", "treemapSectionLabel").attr("x", 6).attr("y", SECTION_HEADER_HEIGHT / 2).attr("dominant-baseline", "middle").text((d) => d.depth === 0 ? "" : d.data.name).attr("font-weight", "bold").attr("style", (d) => {
    ...
    const self = (0,d3__rspack_import_8/* .select */.Ltv)(this);
  ...
  if (config.showValues !== false) {
    ...
    leafValues.each(function(d) {
      const valueTextElement = (0,d3__rspack_import_8/* .select */.Ltv)(this);
      const parentCellNode = this.parentNode;
      if (!parentCellNode) {
        valueTextElement.style("display", "none");
        return;
      }
      const labelElement = (0,d3__rspack_import_8/* .select */.Ltv)(parentCellNode).select(".treemapLabel");
  ...
  (0,_chunk_QN33PNHL_mjs__rspack_import_1/* .setupViewPortForSVG */.P)(svg, diagramPadding, "flowchart", config?.useMaxWidth || false);
}, "draw");
var getClasses = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)(function(_text, diagramObj) {
...
var getStyles = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)(({
  treemap: treemap2
} = {}) => {
  const options = (0,_chunk_S3R3BYOJ_mjs__rspack_import_4/* .cleanAndMerge */.$t)(defaultTreemapStyleOptions, treemap2);
  return `
  .treemapNode.section {
...
//# sourceMappingURL=5061.812c713da48e7bfd.js.map?v=812c713da48e7bfd