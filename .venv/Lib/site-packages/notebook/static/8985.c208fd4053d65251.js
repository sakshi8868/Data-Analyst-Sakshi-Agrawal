"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["8985"], {
97344(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
/* import */ var _lezer_lr__rspack_import_1 = __webpack_require__(5257);
...
class Builder {
    constructor(text, options) {
        ...
        let NP = _lezer_common__rspack_import_0.NodeProp;
        for (let prop in NP) {
            if (NP[prop] instanceof _lezer_common__rspack_import_0.NodeProp && !NP[prop].perNode)
        ...
        for (let prop of this.ast.externalProps) {
            this.knownProps[prop.id.name] = {
                prop: this.options.externalProp ? this.options.externalProp(prop.id.name) : new _lezer_common__rspack_import_0.NodeProp(),
    ...
    getParser() {
        ...
        return _lezer_lr__rspack_import_1/* .LRParser.deserialize */.U1.deserialize({
...
class LocalTokenSet extends TokenSet {
    ...
    buildLocalGroup(states, skipInfo, id) {
        ...
        return {
            groupID: id,
            create: () => new _lezer_lr__rspack_import_1/* .LocalTokenGroup */.uC(fullData, precOffset, this.fallback ? this.fallback.id : undefined),
...
//# sourceMappingURL=8985.c208fd4053d65251.js.map?v=c208fd4053d65251