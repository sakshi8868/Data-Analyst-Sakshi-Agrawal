"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["5896"], {
...
74955(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
...
var ClassMember = class {
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)(this, "ClassMember");
  }
  constructor(input, memberType) {
    ...
    this.classifier = "";
    this.text = "";
    const sanitizedInput = (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .sanitizeText */.jZ)(input, (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig2 */.D7)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .parseGenericTypes */.QO)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .parseGenericTypes */.QO)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .parseGenericTypes */.QO)(this.returnType);
      }
    }
  ...
  parseMember(input) {
    ...
    const combinedText = `${this.visibility ? "\\" + this.visibility : ""}${(0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .parseGenericTypes */.QO)(this.id)}${this.memberType === "method" ? `(${(0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .parseGenericTypes */.QO)(this.parameters)})${this.returnType ? " : " + (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .parseGenericTypes */.QO)(this.returnType) : ""}` : ""}`;
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((txt) => _chunk_ABZYJK2D_mjs__rspack_import_5/* .common_default.sanitizeText */.Y2.sanitizeText(txt, (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig2 */.D7)()), "sanitizeText");
var ClassDB = class {
  constructor() {
    this.relations = [];
    ...
    this.setupToolTips = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((element) => {
      let tooltipElem = (0,d3__rspack_import_7/* .select */.Ltv)(".mermaidTooltip");
      if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
        tooltipElem = (0,d3__rspack_import_7/* .select */.Ltv)("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0);
      }
      const svg = (0,d3__rspack_import_7/* .select */.Ltv)(element).select("svg");
      const nodes = svg.selectAll("g.node");
      nodes.on("mouseover", (event) => {
        const el = (0,d3__rspack_import_7/* .select */.Ltv)(event.currentTarget);
    ...
    this.direction = "TB";
    this.setAccTitle = _chunk_ABZYJK2D_mjs__rspack_import_5/* .setAccTitle */.SV;
    this.getAccTitle = _chunk_ABZYJK2D_mjs__rspack_import_5/* .getAccTitle */.iN;
    this.setAccDescription = _chunk_ABZYJK2D_mjs__rspack_import_5/* .setAccDescription */.EI;
    this.getAccDescription = _chunk_ABZYJK2D_mjs__rspack_import_5/* .getAccDescription */.m7;
    this.setDiagramTitle = _chunk_ABZYJK2D_mjs__rspack_import_5/* .setDiagramTitle */.ke;
    this.getDiagramTitle = _chunk_ABZYJK2D_mjs__rspack_import_5/* .getDiagramTitle */.ab;
    this.getConfig = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)(() => (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig2 */.D7)().class, "getConfig");
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)(this, "ClassDB");
  }
  splitClassNameAndType(_id) {
    const id = _chunk_ABZYJK2D_mjs__rspack_import_5/* .common_default.sanitizeText */.Y2.sanitizeText(_id, (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig2 */.D7)());
    let genericType = "";
    let className = id;
    if (id.indexOf("~") > 0) {
  ...
  addClass(_id) {
    ...
    const name = _chunk_ABZYJK2D_mjs__rspack_import_5/* .common_default.sanitizeText */.Y2.sanitizeText(className, (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig2 */.D7)());
  ...
  addRelation(classRelation) {
    _chunk_AGHRB4JF_mjs__rspack_import_6/* .log.debug */.Rm.debug("Adding relation: " + JSON.stringify(classRelation));
    const invalidTypes = [
    ...
    classRelation.relationTitle1 = _chunk_ABZYJK2D_mjs__rspack_import_5/* .common_default.sanitizeText */.Y2.sanitizeText(
      classRelation.relationTitle1.trim(),
      (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig2 */.D7)()
    );
    classRelation.relationTitle2 = _chunk_ABZYJK2D_mjs__rspack_import_5/* .common_default.sanitizeText */.Y2.sanitizeText(
  ...
  setLink(ids, linkStr, target) {
    const config = (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig2 */.D7)();
    ids.split(",").forEach((_id) => {
      let id = _id;
      if (/\d/.exec(_id[0])) {
        id = MERMAID_DOM_ID_PREFIX + id;
      ...
      if (theClass) {
        theClass.link = _chunk_S3R3BYOJ_mjs__rspack_import_4/* .utils_default.formatUrl */._K.formatUrl(linkStr, config);
  ...
  setClickFunc(_domId, functionName, functionArgs) {
    const domId = _chunk_ABZYJK2D_mjs__rspack_import_5/* .common_default.sanitizeText */.Y2.sanitizeText(_domId, (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig2 */.D7)());
    const config = (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig2 */.D7)();
      ...
      this.functions.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_S3R3BYOJ_mjs__rspack_import_4/* .utils_default.runFunc */._K.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  getData() {
    ...
    for (const classRelation of this.relations) {
      cnt++;
      const edge = {
        id: (0,_chunk_S3R3BYOJ_mjs__rspack_import_4/* .getEdgeId */.rY)(classRelation.id1, classRelation.id2, {
          prefix: "id",
          counter: cnt
        }),
...
var getStyles = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((options) => `g.classGroup text {
...
var getDir = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)((parsedItem, defaultDir = "TB") => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_6/* .__name */.K2)(async function(text, id, _version, diag) {
  _chunk_AGHRB4JF_mjs__rspack_import_6/* .log.info */.Rm.info("REF0:");
  _chunk_AGHRB4JF_mjs__rspack_import_6/* .log.info */.Rm.info("Drawing class diagram (v3)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_ABZYJK2D_mjs__rspack_import_5/* .getConfig2 */.D7)();
  const data4Layout = diag.db.getData();
  const svg = (0,_chunk_55IACEB6_mjs__rspack_import_1/* .getDiagramElement */.A)(id, securityLevel);
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_N4CR4FBY_mjs__rspack_import_3/* .getRegisteredLayoutAlgorithm */.q7)(layout);
  data4Layout.nodeSpacing = conf?.nodeSpacing || 50;
  data4Layout.rankSpacing = conf?.rankSpacing || 50;
  data4Layout.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"];
  data4Layout.diagramId = id;
  await (0,_chunk_N4CR4FBY_mjs__rspack_import_3/* .render */.XX)(data4Layout, svg);
  const padding = 8;
  _chunk_S3R3BYOJ_mjs__rspack_import_4/* .utils_default.insertTitle */._K.insertTitle(
    svg,
    "classDiagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_QN33PNHL_mjs__rspack_import_2/* .setupViewPortForSVG */.P)(svg, padding, "classDiagram", conf?.useMaxWidth ?? true);
}, "draw");
...
//# sourceMappingURL=5896.f5bf4662225c54d7.js.map?v=f5bf4662225c54d7