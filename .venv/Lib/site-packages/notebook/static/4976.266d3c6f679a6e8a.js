"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["4976"], {
...
48019(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var lib0_array = __webpack_require__(24497);
// EXTERNAL MODULE: ../node_modules/lib0/math.js
var lib0_math = __webpack_require__(74740);
// EXTERNAL MODULE: ../node_modules/lib0/map.js
var lib0_map = __webpack_require__(85474);
 ...
 * @param {number} n
 */
const repeat = (source, n) => lib0_array/* .unfold */.t8(n, () => source).join('')
...
const computeParams = () => {
  if (params === undefined) {
    if (isNode) {
      ...
      params = lib0_map/* .create */.vt(); // eslint-disable-next-line no-undef
...
const forceColor = isNode &&
  lib0_function/* .isOneOf */.EK(process.env.FORCE_COLOR, ['true', '1', '2'])
...
const BIT16 = 32768
const BIT17 = 65536
const BIT18 = (/* unused pure expression or super */ null && (1 << 17))
const BIT19 = (/* unused pure expression or super */ null && (1 << 18))
const BIT20 = (/* unused pure expression or super */ null && (1 << 19))
const BIT21 = (/* unused pure expression or super */ null && (1 << 20))
const BIT22 = (/* unused pure expression or super */ null && (1 << 21))
const BIT23 = (/* unused pure expression or super */ null && (1 << 22))
const BIT24 = (/* unused pure expression or super */ null && (1 << 23))
const BIT25 = (/* unused pure expression or super */ null && (1 << 24))
const BIT26 = (/* unused pure expression or super */ null && (1 << 25))
const BIT27 = (/* unused pure expression or super */ null && (1 << 26))
const BIT28 = (/* unused pure expression or super */ null && (1 << 27))
const BIT29 = (/* unused pure expression or super */ null && (1 << 28))
const BIT30 = (/* unused pure expression or super */ null && (1 << 29))
const BIT31 = (/* unused pure expression or super */ null && (1 << 30))
...
const BITS15 = 32767
const BITS16 = 65535
const BITS17 = (/* unused pure expression or super */ null && (BIT18 - 1))
const BITS18 = (/* unused pure expression or super */ null && (BIT19 - 1))
const BITS19 = (/* unused pure expression or super */ null && (BIT20 - 1))
const BITS20 = (/* unused pure expression or super */ null && (BIT21 - 1))
const BITS21 = (/* unused pure expression or super */ null && (BIT22 - 1))
const BITS22 = (/* unused pure expression or super */ null && (BIT23 - 1))
const BITS23 = (/* unused pure expression or super */ null && (BIT24 - 1))
const BITS24 = (/* unused pure expression or super */ null && (BIT25 - 1))
const BITS25 = (/* unused pure expression or super */ null && (BIT26 - 1))
const BITS26 = (/* unused pure expression or super */ null && (BIT27 - 1))
const BITS27 = (/* unused pure expression or super */ null && (BIT28 - 1))
const BITS28 = (/* unused pure expression or super */ null && (BIT29 - 1))
const BITS29 = (/* unused pure expression or super */ null && (BIT30 - 1))
const BITS30 = (/* unused pure expression or super */ null && (BIT31 - 1))
/**
 * @type {number}
 */
...
/* c8 ignore next */
const isInteger = Number.isInteger || (num => typeof num === 'number' && isFinite(num) && lib0_math/* .floor */.RI(num) === num)
 ...
 * @return {boolean}
 */
const encoding_hasContent = encoder => encoder.cpos > 0 || encoder.bufs.length > 0
...
const verifyLen = (encoder, len) => {
  ...
  if (bufferLen - encoder.cpos < len) {
    ...
    encoder.cbuf = new Uint8Array(lib0_math/* .max */.T9(bufferLen, len) * 2)
    encoder.cpos = 0
  }
}
...
const writeVarUint = (encoder, num) => {
  while (num > (/* inlined export .BITS7 */127)) {
    write(encoder, (/* inlined export .BIT8 */128) | ((/* inlined export .BITS7 */127) & num))
    num = lib0_math/* .floor */.RI(num / 128) // shift >>> 7
  }
  write(encoder, (/* inlined export .BITS7 */127) & num)
}
...
const writeVarInt = (encoder, num) => {
  const isNegative = lib0_math/* .isNegativeZero */.sj(num)
  if (isNegative) {
    num = -num
  }
  //             |- whether to continue reading         |- whether is negative     |- number
  write(encoder, (num > (/* inlined export .BITS6 */63) ? (/* inlined export .BIT8 */128) : 0) | (isNegative ? (/* inlined export .BIT7 */64) : 0) | ((/* inlined export .BITS6 */63) & num))
  num = lib0_math/* .floor */.RI(num / 64) // shift >>> 6
  // We don't need to consider the case of num === 0 so we can use a different
  // pattern here than above.
  while (num > 0) {
    write(encoder, (num > (/* inlined export .BITS7 */127) ? (/* inlined export .BIT8 */128) : 0) | ((/* inlined export .BITS7 */127) & num))
    num = lib0_math/* .floor */.RI(num / 128) // shift >>> 7
  }
}
...
const writeUint8Array = (encoder, uint8Array) => {
  ...
  const leftCopyLen = lib0_math/* .min */.jk(bufferLen - cpos, uint8Array.length)
  ...
  if (rightCopyLen > 0) {
    ...
    encoder.cbuf = new Uint8Array(lib0_math/* .max */.T9(bufferLen * 2, rightCopyLen))
    // copy array
...
const writeAny = (encoder, data) => {
  switch (typeof data) {
    case 'string':
      ...
      break
    case 'number':
      if (isInteger(data) && lib0_math/* .abs */.tn(data) <= BITS31) {
        // TYPE 125: INTEGER
        write(encoder, 125)
    ...
    case 'object':
      if (data === null) {
        // TYPE 126: null
        write(encoder, 126)
      } else if (lib0_array/* .isArray */.cy(data)) {
        // TYPE 117: Array
        write(encoder, 117)
...
const readVarUint = decoder => {
  ...
  while (decoder.pos < len) {
    ...
    num = num + (r & (/* inlined export .BITS7 */127)) * mult // shift $r << (7*#iterations) and add it to num
    mult *= 128 // next iteration, shift 7 "more" to the left
    if (r < (/* inlined export .BIT8 */128)) {
      return num
    }
    /* c8 ignore start */
...
const readVarInt = decoder => {
  ...
  let num = r & (/* inlined export .BITS6 */63)
  let mult = 64
  const sign = (r & (/* inlined export .BIT7 */64)) > 0 ? -1 : 1
  if ((r & (/* inlined export .BIT8 */128)) === 0) {
  ...
  while (decoder.pos < len) {
    ...
    // num = num | ((r & binary.BITS7) << len)
    num = num + (r & (/* inlined export .BITS7 */127)) * mult
    mult *= 128
    if (r < (/* inlined export .BIT8 */128)) {
      return sign * num
    }
...
class UintOptRleDecoder extends Decoder {
  ...
  read () {
    if (this.count === 0) {
      ...
      const isNegative = lib0_math/* .isNegativeZero */.sj(this.s)
      this.count = 1
      if (isNegative) {
        this.s = -this.s
...
class IntDiffOptRleDecoder extends Decoder {
  ...
  read () {
    if (this.count === 0) {
      ...
      this.diff = lib0_math/* .floor */.RI(diff / 2) // shift >> 1
      this.count = 1
      if (hasCount) {
        this.count = readVarUint(this) + 2
      }
...
const rand = (/* unused pure expression or super */ null && (Math.random))
...
var lib0_set = __webpack_require__(46456);
 ...
 * @type {Document}
 */
const dom_doc = /** @type {Document} */ (typeof document !== 'undefined' ? document : {})

/**
 * @param {string} name
 * @return {HTMLElement}
 */
const createElement = name => dom_doc.createElement(name)

/**
 * @return {DocumentFragment}
 */
const createDocumentFragment = () => dom_doc.createDocumentFragment()

/**
 * @param {string} text
 * @return {Text}
 */
const createTextNode = text => dom_doc.createTextNode(text)
 ...
 * @return {Element}
 */
const dom_append = (parent, nodes) => {
  appendChild(parent, dom_fragment(nodes))
  return parent
}
...
const dom_element = (name, attrs = [], children = []) =>
  dom_append(setAttributes(createElement(name), attrs), children)

/**
 * @param {number} width
 * @param {number} height
 */
const dom_canvas = (width, height) => {
 ...
 * @return {string}
 */
const mapToStyleString = m => lib0_map/* .map */.Tj(m, (value, key) => `${key}:${value};`).join('')
 ...
 * @return {HTMLElement}
 */
const getElementById = id => /** @type {HTMLElement} */ (dom_doc.getElementById(id))
 ...
 * @return {DocumentFragment}
 */
const parseFragment = html => dom_fragment(/** @type {any} */ (_parse(html).childNodes))
...
const ELEMENT_NODE = dom_doc.ELEMENT_NODE
const TEXT_NODE = dom_doc.TEXT_NODE
const CDATA_SECTION_NODE = dom_doc.CDATA_SECTION_NODE
const COMMENT_NODE = dom_doc.COMMENT_NODE
const DOCUMENT_NODE = dom_doc.DOCUMENT_NODE
const DOCUMENT_TYPE_NODE = dom_doc.DOCUMENT_TYPE_NODE
const DOCUMENT_FRAGMENT_NODE = dom_doc.DOCUMENT_FRAGMENT_NODE
...
const loggingColors = (/* unused pure expression or super */ null && ([GREEN, PURPLE, ORANGE, BLUE]))
let nextColor = 0
let lastLoggingTime = lib0_time/* .getUnixTime */._g()
...
const computeBrowserLoggingArgs = (args) => {
  const strBuilder = []
  const styles = []
  const currentStyle = lib0_map/* .create */.vt()
  /**
...
const vconsoles = lib0_set/* .create */.vt()
...
var object = __webpack_require__(13197);
 ...
 */
class AbstractConnector extends observable/* .Observable */.c {
  /**
   * @param {Doc} ydoc
   * @param {any} awareness
   */
...
const findIndexDS = (dis, clock) => {
  ...
  while (left <= right) {
    const midindex = lib0_math/* .floor */.RI((left + right) / 2);
  ...
  ds.clients.forEach(dels => {
    ...
    for (i = 1, j = 1; i < dels.length; i++) {
      ...
      if (left.clock + left.len >= right.clock) {
        left.len = lib0_math/* .max */.T9(left.len, right.clock + right.len - left.clock);
      } else {
        if (j < i) {
          dels[j] = right;
        }
    ...
    dss[dssI].clients.forEach((delsLeft, client) => {
      if (!merged.clients.has(client)) {
        ...
        for (let i = dssI + 1; i < dss.length; i++) {
          lib0_array/* .appendTo */.S2(dels, dss[i].clients.get(client) || []);
        }
...
const addToDeleteSet = (ds, client, clock, length) => {
  lib0_map/* .setIfUndefined */._4(ds.clients, client, () => /** @type {Array<DeleteItem>} */ ([])).push(new DeleteItem(clock, length));
};
...
const writeDeleteSet = (encoder, ds) => {
  ...
  lib0_array/* .from */.HT(ds.clients.entries())
    .sort((a, b) => b[0] - a[0])
...
const readDeleteSet = decoder => {
  ...
  for (let i = 0; i < numClients; i++) {
    ...
    if (numberOfDeletes > 0) {
      const dsField = lib0_map/* .setIfUndefined */._4(ds.clients, client, () => /** @type {Array<DeleteItem>} */ ([]));
 ...
 */
class Doc extends observable/* .Observable */.c {
  /**
  ...
  getSubdocGuids () {
    return new Set(lib0_array/* .from */.HT(this.subdocs).map(doc => doc.guid))
  }
  ...
  get (name, TypeConstructor = AbstractType) {
    const type = lib0_map/* .setIfUndefined */._4(this.share, name, () => {
      // @ts-ignore
   ...
   */
  destroy () {
    lib0_array/* .from */.HT(this.subdocs).forEach(subdoc => subdoc.destroy());
    const item = this._item;
    if (item !== null) {
      this._item = null;
...
const writeStructs = (encoder, structs, client, clock) => {
  // write first id
  clock = lib0_math/* .max */.T9(clock, structs[0].id.clock); // make sure the first id exists
...
const writeClientsStructs = (encoder, store, _sm) => {
  ...
  lib0_array/* .from */.HT(sm.entries()).sort((a, b) => b[0] - a[0]).forEach(([client, clock]) => {
...
const readClientsStructRefs = (decoder, doc) => {
   ...
   */
  const clientRefs = lib0_map/* .create */.vt();
  ...
  for (let i = 0; i < numOfStateUpdates; i++) {
    ...
    for (let i = 0; i < numberOfStructs; i++) {
      ...
      switch ((/* inlined export .BITS5 */31) & info) {
        case 0: { // GC
        ...
        default: { // Item with content
           ...
           * a few comments
           */
          const cantCopyParentInfo = (info & ((/* inlined export .BIT7 */64) | (/* inlined export .BIT8 */128))) === 0;
          ...
          const struct = new Item(
            ...
            null, // leftd
            (info & (/* inlined export .BIT8 */128)) === (/* inlined export .BIT8 */128) ? decoder.readLeftID() : null, // origin
            null, // right
            (info & (/* inlined export .BIT7 */64)) === (/* inlined export .BIT7 */64) ? decoder.readRightID() : null, // right origin
            cantCopyParentInfo ? (decoder.readParentInfo() ? doc.get(decoder.readString()) : decoder.readLeftID()) : null, // parent
            cantCopyParentInfo && (info & (/* inlined export .BIT6 */32)) === (/* inlined export .BIT6 */32) ? decoder.readString() : null, // parentSub
...
const integrateStructs = (transaction, store, clientsStructRefs) => {
  ...
  let clientsStructRefsIds = lib0_array/* .from */.HT(clientsStructRefs.keys()).sort((a, b) => a - b);
  ...
  while (true) {
    if (stackHead.constructor !== Skip) {
      const localClock = lib0_map/* .setIfUndefined */._4(state, stackHead.id.client, () => getState(store, stackHead.id.client));
...
const writeStateVector = (encoder, sv) => {
  ...
  lib0_array/* .from */.HT(sv.entries()).sort((a, b) => b[0] - a[0]).forEach(([client, clock]) => {
...
const callEventHandlerListeners = (eventHandler, arg0, arg1) =>
  lib0_function/* .callAll */.OK(eventHandler.l, [arg0, arg1]);
...
const splitSnapshotAffectedStructs = (transaction, snapshot) => {
  const meta = lib0_map/* .setIfUndefined */._4(transaction.meta, splitSnapshotAffectedStructs, lib0_set/* .create */.vt);
...
const findIndexSS = (structs, clock) => {
  ...
  let midindex = lib0_math/* .floor */.RI((clock / (midclock + mid.length - 1)) * right); // pivoting the search
  while (left <= right) {
    ...
    midindex = lib0_math/* .floor */.RI((left + right) / 2);
  }
...
const writeUpdateMessageFromTransaction = (encoder, transaction) => {
  if (transaction.deleteSet.clients.size === 0 && !lib0_map/* .any */.bz(transaction.afterState, (clock, client) => transaction.beforeState.get(client) !== clock)) {
    return false
  }
...
const addChangedTypeToTransaction = (transaction, type, parentSub) => {
  ...
  if (item === null || (item.id.clock < (transaction.beforeState.get(item.id.client) || 0) && !item.deleted)) {
    lib0_map/* .setIfUndefined */._4(transaction.changed, type, lib0_set/* .create */.vt).add(parentSub);
  }
};
...
const tryMergeDeleteSet = (ds, store) => {
  ...
  ds.clients.forEach((deleteItems, client) => {
    ...
    for (let di = deleteItems.length - 1; di >= 0; di--) {
      ...
      const mostRightIndexToCheck = lib0_math/* .min */.jk(structs.length - 1, 1 + findIndexSS(structs, deleteItem.clock + deleteItem.len - 1));
      for (
    ...
    try {
      ...
      transaction.afterState.forEach((clock, client) => {
        ...
        if (beforeClock !== clock) {
          ...
          const firstChangePos = lib0_math/* .max */.T9(findIndexSS(structs, beforeClock), 1);
 ...
 */
class UndoManager extends observable/* .Observable */.c {
  /**
  ...
  constructor (typeScope, {
    ...
    doc = /** @type {Doc} */ (lib0_array/* .isArray */.cy(typeScope) ? typeScope[0].doc : typeScope.doc)
  } = {}) {
    super();
    /**
   ...
   */
  addToScope (ytypes) {
    ytypes = lib0_array/* .isArray */.cy(ytypes) ? ytypes : [ytypes];
  ...
  for (let i = 0; i < numOfStateUpdates; i++) {
    ...
    for (let i = 0; i < numberOfStructs; i++) {
      ...
      if (info === 10) {
        ...
        clock += len;
      } else if (((/* inlined export .BITS5 */31) & info) !== 0) {
        const cantCopyParentInfo = (info & ((/* inlined export .BIT7 */64) | (/* inlined export .BIT8 */128))) === 0;
        // If parent = null and neither left nor right are defined, then we know that `parent` is child of `y`
        // and we read the next string as parentYKey.
        // It indicates how we store/retrieve parent from `y.share`
...
const diffUpdateV2 = (update, sv, YDecoder = UpdateDecoderV2, YEncoder = UpdateEncoderV2) => {
  ...
  while (reader.curr) {
    ...
    if (curr.id.clock + curr.length > svClock) {
      writeStructToLazyStructWriter(lazyStructWriter, curr, lib0_math/* .max */.T9(svClock - curr.id.clock, 0));
      reader.next();
...
const createObfuscator = ({ formatting = true, subdocs = true, yxml = true } = {}) => {
  let i = 0;
  const mapKeyCache = lib0_map/* .create */.vt();
  const nodeNameCache = lib0_map/* .create */.vt();
  const formattingKeyCache = lib0_map/* .create */.vt();
  const formattingValueCache = lib0_map/* .create */.vt();
      ...
      case Item: {
        ...
        switch (content.constructor) {
          ...
          case ContentType: {
            if (yxml) {
              ...
              if (type instanceof YXmlElement) {
                type.nodeName = lib0_map/* .setIfUndefined */._4(nodeNameCache, type.nodeName, () => 'node-' + i);
              }
              if (type instanceof YXmlHook) {
                type.hookName = lib0_map/* .setIfUndefined */._4(nodeNameCache, type.hookName, () => 'hook-' + i);
              }
            }
            break
          }
          ...
          case ContentFormat: {
            ...
            if (formatting) {
              c.key = lib0_map/* .setIfUndefined */._4(formattingKeyCache, c.key, () => i + '');
              c.value = lib0_map/* .setIfUndefined */._4(formattingValueCache, c.value, () => ({ i }));
            }
            break
          }
          case ContentJSON: {
        ...
        if (item.parentSub) {
          item.parentSub = lib0_map/* .setIfUndefined */._4(mapKeyCache, item.parentSub, () => i + '');
        }
        i++;
        return block
      }
...
class YEvent {
          ...
          if (this.adds(item)) {
            ...
            if (this.deletes(item)) {
              if (prev !== null && this.deletes(prev)) {
                action = 'delete';
                oldValue = lib0_array/* .last */.HV(prev.content.getContent());
              } else {
                return
              }
            } else {
            ...
            if (this.deletes(item)) {
              action = 'delete';
              oldValue = lib0_array/* .last */.HV(/** @type {Item} */ item.content.getContent());
            } else {
              return // nop
            }
          }
  ...
  get changes () {
    ...
    if (changes === null) {
      ...
      const target = this.target;
      const added = lib0_set/* .create */.vt();
      const deleted = lib0_set/* .create */.vt();
      /**
...
const findMarker = (yarray, index) => {
  ...
  const marker = yarray._searchMarker.length === 0 ? null : yarray._searchMarker.reduce((a, b) => lib0_math/* .abs */.tn(index - a.index) < lib0_math/* .abs */.tn(index - b.index) ? a : b);
  let p = yarray._start;
  let pindex = 0;
  if (marker !== null) {
    p = marker.p;
  ...
  // }
  if (marker !== null && lib0_math/* .abs */.tn(marker.index - pindex) < /** @type {YText|YArray<any>} */ (p.parent).length / maxSearchMarker) {
...
const updateMarkerChanges = (searchMarker, index, len) => {
  for (let i = searchMarker.length - 1; i >= 0; i--) {
    ...
    if (index < m.index || (len > 0 && index === m.index)) { // a simple index <= m.index check would actually suffice
      m.index = lib0_math/* .max */.T9(index, m.index + len);
    }
  }
};
...
const callTypeObservers = (type, transaction, event) => {
  ...
  while (true) {
    // @ts-ignore
    lib0_map/* .setIfUndefined */._4(changedParentTypes, type, () => []).push(event);
    if (type._item === null) {
      break
    }
 ...
 * @return {boolean}
 */
const equalAttrs = (a, b) => a === b || (typeof a === 'object' && typeof b === 'object' && a && b && object/* .equalFlat */.SQ(a, b));
...
const cleanupFormattingGap = (transaction, start, curr, startAttributes, currAttributes) => {
   ...
   */
  const endFormats = lib0_map/* .create */.vt();
...
const cleanupYTextFormatting = type => {
  ...
  transact(/** @type {Doc} */ (type.doc), transaction => {
    ...
    let end = type._start;
    let startAttributes = lib0_map/* .create */.vt();
    const currentAttributes = lib0_map/* .copy */.C(startAttributes);
    while (end) {
      if (end.deleted === false) {
        switch (end.content.constructor) {
          ...
          default:
            ...
            startAttributes = lib0_map/* .copy */.C(currentAttributes);
            start = end;
            break
        }
      }
...
const deleteText = (transaction, currPos, length) => {
  const startLength = length;
  const startAttrs = lib0_map/* .copy */.C(currPos.currentAttributes);
          ...
          if (action !== null) {
            ...
            switch (action) {
              ...
              case 'retain':
                if (retain > 0) {
                  op = { retain };
                  if (!object/* .isEmpty */.Im(attributes)) {
                    op.attributes = object/* .assign */.kp({}, attributes);
                  }
                }
                retain = 0;
                break
...
class YXmlFragment extends AbstractType {
  ...
  querySelectorAll (query) {
    query = query.toUpperCase();
    // @ts-ignore
    return lib0_array/* .from */.HT(new YXmlTreeWalker(this, element => element.nodeName && element.nodeName.toUpperCase() === query))
  }
...
class YXmlElement extends YXmlFragment {
  ...
  clone () {
    ...
    object/* .forEach */.jJ(attrs, (value, key) => {
 ...
 * @param {ID} id
 */
const isDeletedByUndoStack = (stack, id) => lib0_array/* .some */.zN(stack, /** @param {StackItem} s */ s => isDeleted(s.deletions, id));
...
class Item extends AbstractStruct {
  ...
  constructor (id, left, origin, right, rightOrigin, parent, parentSub, content) {
     ...
     * @type {number} byte
     */
    this.info = this.content.isCountable() ? (/* inlined export .BIT2 */2) : 0;
  }
   ...
   */
  set marker (isMarked) {
    if (((this.info & (/* inlined export .BIT4 */8)) > 0) !== isMarked) {
      this.info ^= (/* inlined export .BIT4 */8);
    }
  }

  get marker () {
    return (this.info & (/* inlined export .BIT4 */8)) > 0
  }
   ...
   */
  get keep () {
    return (this.info & (/* inlined export .BIT1 */1)) > 0
  }

  set keep (doKeep) {
    if (this.keep !== doKeep) {
      this.info ^= (/* inlined export .BIT1 */1);
    }
  }

  get countable () {
    return (this.info & (/* inlined export .BIT2 */2)) > 0
  }
   ...
   */
  get deleted () {
    return (this.info & (/* inlined export .BIT3 */4)) > 0
  }

  set deleted (doDelete) {
    if (this.deleted !== doDelete) {
      this.info ^= (/* inlined export .BIT3 */4);
    }
  }
  ...
  write (encoder, offset) {
    ...
    const info = (this.content.getRef() & (/* inlined export .BITS5 */31)) |
      (origin === null ? 0 : (/* inlined export .BIT8 */128)) | // origin is defined
      (rightOrigin === null ? 0 : (/* inlined export .BIT7 */64)) | // right origin is defined
      (parentSub === null ? 0 : (/* inlined export .BIT6 */32)); // parentSub is non-null
 ...
 * @param {number} info
 */
const readItemContent = (decoder, info) => contentRefs[info & (/* inlined export .BITS5 */31)](decoder);
...
//# sourceMappingURL=4976.266d3c6f679a6e8a.js.map?v=266d3c6f679a6e8a