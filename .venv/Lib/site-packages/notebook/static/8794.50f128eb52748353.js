"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["8794"], {
47409(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
const identifiers = new dist/* .ExternalTokenizer */.Lu((input, stack) => {
  for (let inside = false, dashes = 0, i = 0;; i++) {
    ...
    if (isAlpha(next) || next == dash || next == underscore || (inside && isDigit(next))) {
      ...
      if (inside)
        input.acceptToken(next == parenL ? dist_callee : dashes == 2 && stack.canShift(VariableName) ? VariableName : identifier);
      break
    }
  }
});
...
const parser = dist/* .LRParser.deserialize */.U1.deserialize({
  ...
  tokenizers: [descendant, unitToken, identifiers, 1, 2, 3, 4, new dist/* .LocalTokenGroup */.uC("m~RRYZ[z{a~~g~aO#^~~dP!P!Qg~lO#_~~", 28, 105)],
...
//# sourceMappingURL=8794.50f128eb52748353.js.map?v=50f128eb52748353