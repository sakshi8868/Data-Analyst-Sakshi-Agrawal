"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["7295"], {
...
93826(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
/* export default */ const esm_browser_native = ({ randomUUID });
...
/* export default */ const esm_browser_stringify = ((/* unused pure expression or super */ null && (stringify)));
...
var MindmapDB = class {
  ...
  addNode(level, id, descr, type) {
    chunk_AGHRB4JF/* .log.info */.Rm.info("addNode", level, id, descr, type);
    let isRoot = false;
    ...
    let padding = conf.mindmap?.padding ?? chunk_ABZYJK2D/* .defaultConfig_default.mindmap.padding */.UI.mindmap.padding;
    switch (type) {
    ...
    const node = {
      ...
      type,
      children: [],
      width: conf.mindmap?.maxNodeWidth ?? chunk_ABZYJK2D/* .defaultConfig_default.mindmap.maxNodeWidth */.UI.mindmap.maxNodeWidth,
      padding,
      isRoot
    };
  ...
  getType(startStr, endStr) {
    chunk_AGHRB4JF/* .log.debug */.Rm.debug("In get type", startStr, endStr);
    switch (startStr) {
      case "[":
  ...
  getData() {
    ...
    chunk_AGHRB4JF/* .log.debug */.Rm.debug("getData: mindmapRoot", mindmapRoot, config);
...
var draw = /* @__PURE__ */ (0,chunk_AGHRB4JF/* .__name */.K2)(async (text, id, _version, diagObj) => {
  chunk_AGHRB4JF/* .log.debug */.Rm.debug("Rendering mindmap diagram\n" + text);
  const db = diagObj.db;
  ...
  (0,chunk_QN33PNHL/* .setupViewPortForSVG */.P)(
    svg,
    data4Layout.config.mindmap?.padding ?? chunk_ABZYJK2D/* .defaultConfig_default.mindmap.padding */.UI.mindmap.padding,
    "mindmapDiagram",
    data4Layout.config.mindmap?.useMaxWidth ?? chunk_ABZYJK2D/* .defaultConfig_default.mindmap.useMaxWidth */.UI.mindmap.useMaxWidth
  );
}, "draw");
...
//# sourceMappingURL=7295.840e8e597a4c9874.js.map?v=840e8e597a4c9874