"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["5927"], {
20442(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
/* import */ var _jupyterlab_docmanager__rspack_import_4 = __webpack_require__(40808);
...
/* import */ var _jupyterlab_docregistry__rspack_import_5 = __webpack_require__(64646);
/* import */ var _jupyterlab_docregistry__rspack_import_5_default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_docregistry__rspack_import_5);
/* import */ var _jupyterlab_mainmenu__rspack_import_6 = __webpack_require__(35248);
/* import */ var _jupyterlab_mainmenu__rspack_import_6_default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_mainmenu__rspack_import_6);
/* import */ var _jupyterlab_rendermime__rspack_import_7 = __webpack_require__(93468);
/* import */ var _jupyterlab_rendermime__rspack_import_7_default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_rendermime__rspack_import_7);
/* import */ var _jupyterlab_settingregistry__rspack_import_8 = __webpack_require__(21214);
/* import */ var _jupyterlab_settingregistry__rspack_import_8_default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_settingregistry__rspack_import_8);
/* import */ var _jupyterlab_translation__rspack_import_9 = __webpack_require__(51126);
/* import */ var _jupyterlab_translation__rspack_import_9_default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_translation__rspack_import_9);
/* import */ var _jupyter_notebook_application__rspack_import_10 = __webpack_require__(47926);
/* import */ var _jupyter_notebook_application__rspack_import_10_default = /*#__PURE__*/__webpack_require__.n(_jupyter_notebook_application__rspack_import_10);
/* import */ var _jupyter_notebook_ui_components__rspack_import_11 = __webpack_require__(4212);
/* import */ var _jupyter_notebook_ui_components__rspack_import_11_default = /*#__PURE__*/__webpack_require__.n(_jupyter_notebook_ui_components__rspack_import_11);
/* import */ var _lumino_coreutils__rspack_import_12 = __webpack_require__(83044);
/* import */ var _lumino_coreutils__rspack_import_12_default = /*#__PURE__*/__webpack_require__.n(_lumino_coreutils__rspack_import_12);
/* import */ var _lumino_disposable__rspack_import_13 = __webpack_require__(42574);
/* import */ var _lumino_disposable__rspack_import_13_default = /*#__PURE__*/__webpack_require__.n(_lumino_disposable__rspack_import_13);
/* import */ var _lumino_widgets__rspack_import_14 = __webpack_require__(64406);
/* import */ var _lumino_widgets__rspack_import_14_default = /*#__PURE__*/__webpack_require__.n(_lumino_widgets__rspack_import_14);
...
const dirty = {
    ...
    autoStart: true,
    requires: [_jupyterlab_application__rspack_import_0.ILabStatus, _jupyterlab_translation__rspack_import_9.ITranslator],
    activate: (app, status, translator) => {
        if (!(app instanceof _jupyter_notebook_application__rspack_import_10.NotebookApp)) {
...
const info = {
    ...
    autoStart: true,
    provides: _jupyterlab_application__rspack_import_0.JupyterLab.IInfo,
    activate: (app) => {
        if (!(app instanceof _jupyter_notebook_application__rspack_import_10.NotebookApp)) {
...
const logo = {
    ...
    activate: (app) => {
        ...
        const logo = new _lumino_widgets__rspack_import_14.Widget({ node });
        _jupyter_notebook_ui_components__rspack_import_11.jupyterIcon.element({
            container: node,
...
const opener = {
    ...
    autoStart: true,
    requires: [_jupyterlab_application__rspack_import_0.IRouter, _jupyterlab_docmanager__rspack_import_4.IDocumentManager],
    optional: [_jupyterlab_settingregistry__rspack_import_8.ISettingRegistry],
...
const menus = {
    ...
    requires: [_jupyterlab_mainmenu__rspack_import_6.IMainMenu],
    autoStart: true,
    activate: (app, menu) => {
        // always disable the Tabs menu
        menu.tabsMenu.dispose();
        const page = _jupyterlab_coreutils__rspack_import_3.PageConfig.getOption('notebookPage');
        switch (page) {
            case 'consoles':
            case 'terminals':
            case 'tree':
...
const menuSpacer = {
    ...
    autoStart: true,
    activate: (app) => {
        const menu = new _lumino_widgets__rspack_import_14.Widget();
        menu.id = _jupyterlab_apputils__rspack_import_1.DOMUtils.createDomID();
...
const pages = {
    ...
    autoStart: true,
    requires: [_jupyterlab_translation__rspack_import_9.ITranslator],
    optional: [_jupyterlab_apputils__rspack_import_1.ICommandPalette],
    activate: (app, translator, palette) => {
        ...
        app.commands.addCommand(CommandIDs.openLab, {
            ...
            execute: () => {
                window.open(_jupyterlab_coreutils__rspack_import_3.URLExt.join(baseUrl, 'lab'));
            },
        });
        const page = _jupyterlab_coreutils__rspack_import_3.PageConfig.getOption('notebookPage');
        app.commands.addCommand(CommandIDs.openTree, {
            ...
            execute: () => {
                if (page === 'tree') {
                    ...
                    window.open(_jupyterlab_coreutils__rspack_import_3.URLExt.join(baseUrl, 'tree'));
                }
            },
        });
        if (palette) {
...
const pathOpener = {
    ...
    autoStart: true,
    provides: _jupyter_notebook_application__rspack_import_10.INotebookPathOpener,
    activate: (app) => {
        return _jupyter_notebook_application__rspack_import_10.defaultNotebookPathOpener;
    },
};
/**
...
const paths = {
    ...
    autoStart: true,
    provides: _jupyterlab_application__rspack_import_0.JupyterFrontEnd.IPaths,
    activate: (app) => {
        if (!(app instanceof _jupyter_notebook_application__rspack_import_10.NotebookApp)) {
...
const rendermime = {
    ...
    autoStart: true,
    provides: _jupyterlab_rendermime__rspack_import_7.IRenderMimeRegistry,
    optional: [
        _jupyterlab_docmanager__rspack_import_4.IDocumentManager,
        _jupyterlab_rendermime__rspack_import_7.ILatexTypesetter,
        _jupyterlab_apputils__rspack_import_1.ISanitizer,
        _jupyterlab_rendermime__rspack_import_7.IMarkdownParser,
        _jupyterlab_translation__rspack_import_9.ITranslator,
        _jupyter_notebook_application__rspack_import_10.INotebookPathOpener,
    ],
    activate: (app, docManager, latexTypesetter, sanitizer, markdownParser, translator, notebookPathOpener) => {
        const trans = (translator !== null && translator !== void 0 ? translator : _jupyterlab_translation__rspack_import_9.nullTranslator).load('jupyterlab');
        const opener = notebookPathOpener !== null && notebookPathOpener !== void 0 ? notebookPathOpener : _jupyter_notebook_application__rspack_import_10.defaultNotebookPathOpener;
        if (docManager) {
            app.commands.addCommand(CommandIDs.handleLink, {
                ...
                execute: (args) => {
                    ...
                    return docManager.services.contents
                        ...
                        const baseUrl = _jupyterlab_coreutils__rspack_import_3.PageConfig.getBaseUrl();
                        opener.open({
                            prefix: _jupyterlab_coreutils__rspack_import_3.URLExt.join(baseUrl, 'tree'),
                            path: model.path,
                            target: '_blank',
                        });
                    });
        ...
        return new _jupyterlab_rendermime__rspack_import_7.RenderMimeRegistry({
            initialFactories: _jupyterlab_rendermime__rspack_import_7.standardRendererFactories,
...
const shell = {
    ...
    autoStart: true,
    provides: _jupyter_notebook_application__rspack_import_10.INotebookShell,
    optional: [_jupyterlab_settingregistry__rspack_import_8.ISettingRegistry],
    activate: (app, settingRegistry) => {
        if (!(app.shell instanceof _jupyter_notebook_application__rspack_import_10.NotebookShell)) {
...
const splash = {
    ...
    autoStart: true,
    provides: _jupyterlab_apputils__rspack_import_1.ISplashScreen,
    activate: (app) => {
        const { restored } = app;
        ...
        return {
            show: (light = true) => {
                ...
                return new _lumino_disposable__rspack_import_13.DisposableDelegate(async () => {
                    await restored;
...
const status = {
    ...
    autoStart: true,
    provides: _jupyterlab_application__rspack_import_0.ILabStatus,
    activate: (app) => {
        if (!(app instanceof _jupyter_notebook_application__rspack_import_10.NotebookApp)) {
...
const tabTitle = {
    ...
    autoStart: true,
    requires: [_jupyter_notebook_application__rspack_import_10.INotebookShell],
    activate: (app, shell) => {
        const setTabTitle = () => {
            const current = shell.currentWidget;
            if (current instanceof _jupyterlab_console__rspack_import_2.ConsolePanel) {
                const update = () => {
                    const title = current.sessionContext.path || current.sessionContext.name;
                    const basename = _jupyterlab_coreutils__rspack_import_3.PathExt.basename(title);
            ...
            else if (current instanceof _jupyterlab_docregistry__rspack_import_5.DocumentWidget) {
                const update = () => {
                    const basename = _jupyterlab_coreutils__rspack_import_3.PathExt.basename(current.context.path);
                    document.title = basename.replace(STRIP_IPYNB, '');
                };
...
const title = {
    ...
    autoStart: true,
    requires: [_jupyter_notebook_application__rspack_import_10.INotebookShell, _jupyterlab_translation__rspack_import_9.ITranslator],
    optional: [_jupyterlab_docmanager__rspack_import_4.IDocumentManager, _jupyterlab_application__rspack_import_0.IRouter, _jupyterlab_apputils__rspack_import_1.IToolbarWidgetRegistry],
    activate: (app, shell, translator, docManager, router, toolbarRegistry) => {
        ...
        if (toolbarRegistry) {
            toolbarRegistry.addFactory('TopBar', 'widgetTitle', (toolbar) => {
                const widget = new _lumino_widgets__rspack_import_14.Widget({ node });
                widget.id = 'jp-title';
                return widget;
            });
        }
        const addTitle = async () => {
            const current = shell.currentWidget;
            if (!current || !(current instanceof _jupyterlab_docregistry__rspack_import_5.DocumentWidget)) {
                return;
            }
            ...
            commands.addCommand(CommandIDs.rename, {
                ...
                execute: async () => {
                    ...
                    try {
                        const result = await (0,_jupyterlab_docmanager__rspack_import_4.renameDialog)(docManager, current.context);
                        ...
                        (0,_jupyterlab_apputils__rspack_import_1.showErrorMessage)(trans.__('Rename Error'), error.message ||
                            trans.__('An error occurred while renaming the file.'));
                        return;
                    }
                    const newPath = current.context.path;
                    const basename = _jupyterlab_coreutils__rspack_import_3.PathExt.basename(newPath);
...
const topVisibility = {
    ...
    requires: [_jupyter_notebook_application__rspack_import_10.INotebookShell, _jupyterlab_translation__rspack_import_9.ITranslator],
    optional: [_jupyterlab_settingregistry__rspack_import_8.ISettingRegistry, _jupyterlab_apputils__rspack_import_1.ICommandPalette],
...
const sidePanelVisibility = {
    ...
    requires: [_jupyter_notebook_application__rspack_import_10.INotebookShell, _jupyterlab_translation__rspack_import_9.ITranslator],
    optional: [_jupyterlab_mainmenu__rspack_import_6.IMainMenu, _jupyterlab_apputils__rspack_import_1.ICommandPalette],
    autoStart: true,
    activate: (app, notebookShell, translator, menu, palette) => {
        ...
        const updateMenu = (area, entryLabel) => {
            ...
            const newMenu = new _lumino_widgets__rspack_import_14.Menu({ commands: app.commands });
        ...
        app.restored.then(() => {
            ...
            if (palette) {
                const sidePanelPalette = new _jupyter_notebook_application__rspack_import_10.SidePanelPalette({
...
const tree = {
    ...
    provides: _jupyterlab_application__rspack_import_0.JupyterFrontEnd.ITreeResolver,
    activate: (app, router) => {
        const { commands } = app;
        const set = new _lumino_disposable__rspack_import_13.DisposableSet();
        const delegate = new _lumino_coreutils__rspack_import_12.PromiseDelegate();
        ...
        set.add(commands.addCommand(CommandIDs.resolveTree, {
            execute: (async (args) => {
                ...
                const query = _jupyterlab_coreutils__rspack_import_3.URLExt.queryStringToObject((_a = args.search) !== null && _a !== void 0 ? _a : '');
                const browser = query['file-browser-path'] || '';
                // Remove the file browser path from the query string.
                delete query['file-browser-path'];
                // Clean up artifacts immediately upon routing.
                set.dispose();
                delegate.resolve({ browser, file: _jupyterlab_coreutils__rspack_import_3.PageConfig.getOption('treePath') });
            }),
        }));
        ...
        set.add(new _lumino_disposable__rspack_import_13.DisposableDelegate(() => {
...
const treePathUpdater = {
    ...
    requires: [_jupyterlab_application__rspack_import_0.IRouter],
    provides: _jupyterlab_application__rspack_import_0.ITreePathUpdater,
    activate: (app, router) => {
        function updateTreePath(treePath) {
            if (treePath !== _jupyterlab_coreutils__rspack_import_3.PageConfig.getOption('treePath')) {
                const path = _jupyterlab_coreutils__rspack_import_3.URLExt.join(_jupyterlab_coreutils__rspack_import_3.PageConfig.getOption('baseUrl') || '/', 'tree', _jupyterlab_coreutils__rspack_import_3.URLExt.encodeParts(treePath));
                router.navigate(path, { skipRouting: true });
                // Persist the new tree path to PageConfig as it is used elsewhere at runtime.
                _jupyterlab_coreutils__rspack_import_3.PageConfig.setOption('treePath', treePath);
            }
        }
...
const zen = {
    ...
    autoStart: true,
    requires: [_jupyterlab_translation__rspack_import_9.ITranslator],
    optional: [_jupyterlab_apputils__rspack_import_1.ICommandPalette, _jupyter_notebook_application__rspack_import_10.INotebookShell],
...
//# sourceMappingURL=5927.df5c4f7354680535.js.map?v=df5c4f7354680535