"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["6432"], {
40467(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/apputils@~4.7.0-alpha.2 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/node_modules/@jupyterlab/apputils/lib/index.js)
var index_js_ = __webpack_require__(12751);
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/coreutils@~6.6.0-alpha.2 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/node_modules/@jupyterlab/coreutils/lib/index.js)
var lib_index_js_ = __webpack_require__(50514);
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/debugger@~4.6.0-alpha.2 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/node_modules/@jupyterlab/debugger/lib/index.js)
var debugger_lib_index_js_ = __webpack_require__(37220);
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/docmanager@~4.6.0-alpha.2 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/node_modules/@jupyterlab/docmanager/lib/index.js)
var docmanager_lib_index_js_ = __webpack_require__(40808);
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/mainmenu@~4.6.0-alpha.2 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/node_modules/@jupyterlab/mainmenu/lib/index.js)
var mainmenu_lib_index_js_ = __webpack_require__(35248);
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/notebook@~4.6.0-alpha.2 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/node_modules/@jupyterlab/notebook/lib/index.js)
var notebook_lib_index_js_ = __webpack_require__(71592);
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/settingregistry@~4.6.0-alpha.2 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/node_modules/@jupyterlab/settingregistry/lib/index.js)
var settingregistry_lib_index_js_ = __webpack_require__(21214);
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/toc@~6.6.0-alpha.2 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/node_modules/@jupyterlab/toc/lib/index.js)
var toc_lib_index_js_ = __webpack_require__(58470);
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/translation@~4.6.0-alpha.2 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/node_modules/@jupyterlab/translation/lib/index.js)
var translation_lib_index_js_ = __webpack_require__(51126);
// EXTERNAL MODULE: consume shared module (default) @jupyter-notebook/application@~7.6.0-alpha.2 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/packages/application/lib/index.js)
var application_lib_index_js_ = __webpack_require__(47926);
...
// EXTERNAL MODULE: consume shared module (default) @lumino/widgets@~2.7.3 (strict) (fallback: /home/runner/work/notebook/notebook/.jupyter_releaser_checkout/node_modules/@lumino/widgets/dist/index.es6.js)
var widgets_dist_index_es6_js_ = __webpack_require__(64406);
...
})(trusted_TrustedComponent || (trusted_TrustedComponent = {}));
    ...
    activate: (app, docManager, translator, notebookShell, toolbarRegistry, settingRegistry) => {
        ...
        if (toolbarRegistry) {
            toolbarRegistry.addFactory('TopBar', 'checkpoint', (toolbar) => {
                const widget = new widgets_dist_index_es6_js_.Widget({ node });
        ...
        const createPoll = () => {
            ...
            if (checkpointPollingInterval > 0) {
                poll = new dist_index_es6_js_.Poll({
                    auto: true,
        ...
        if (settingRegistry) {
            const loadSettings = settingRegistry.load(lib_checkpoints.id);
            Promise.all([loadSettings, app.restored])
                ...
                .catch((reason) => {
                console.error(`Failed to load settings for ${lib_checkpoints.id}: ${reason.message}`);
...
const fullWidthNotebook = {
    ...
    activate: (app, tracker, palette, settingRegistry, translator) => {
        ...
        app.commands.addCommand(lib_CommandIDs.toggleFullWidth, {
        ...
        if (palette) {
            palette.addItem({
                command: lib_CommandIDs.toggleFullWidth,
...
const lib_trusted = {
    ...
    activate: (app, notebookShell, translator) => {
        const onChange = async () => {
            ...
            const widget = trusted_TrustedComponent.create({ notebook, translator });
...
const editNotebookMetadata = {
    ...
    activate: (app, palette, translator, notebookTools) => {
        ...
        translator = translator !== null && translator !== void 0 ? translator : translation_lib_index_js_.nullTranslator;
        const trans = translator.load('notebook');
        commands.addCommand(lib_CommandIDs.openEditNotebookMetadata, {
        ...
        if (palette) {
            palette.addItem({
                command: lib_CommandIDs.openEditNotebookMetadata,
                category: 'Notebook Operations',
            });
        }
    },
...
const overrideMenuItems = {
    ...
    autoStart: true,
    optional: [
        debugger_lib_index_js_.IDebuggerSidebar,
        mainmenu_lib_index_js_.IMainMenu,
        application_lib_index_js_.INotebookShell,
        toc_lib_index_js_.ITableOfContentsTracker,
        ...
        if (tocTracker) {
            ...
            commands.addCommand('toc:toggle-panel', {
                ...
                isToggled: () => {
                    ...
                    const widget = (0,index_es6_js_.find)(shell.widgets(area), (w) => w.id === TOC_PANEL_ID);
                    if (!widget) {
                        return false;
                    }
        ...
        if (debuggerSidebar) {
            ...
            commands.addCommand('debugger:toggle-panel', {
                ...
                isToggled: () => {
                    ...
                    const widget = (0,index_es6_js_.find)(shell.widgets(area), (w) => w.id === DEBUGGER_PANEL_ID);
                    if (!widget) {
                        return false;
                    }
                    return shell.isSidePanelVisible(area) && widget.isVisible;
...
//# sourceMappingURL=6432.24b8b0c99407199b.js.map?v=24b8b0c99407199b