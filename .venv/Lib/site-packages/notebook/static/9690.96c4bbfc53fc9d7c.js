"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["9690"], {
74065(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var src = __webpack_require__(38646);
...
/* export default */ const src_path = (path);
...
/* export default */ function sankeyLinkHorizontal() {
...
var sankeyDiagram_TZEHDZUN_links = [];
var sankeyDiagram_TZEHDZUN_nodes = [];
var nodesMap = /* @__PURE__ */ new Map();
var clear2 = /* @__PURE__ */ (0,chunk_AGHRB4JF/* .__name */.K2)(() => {
  sankeyDiagram_TZEHDZUN_links = [];
  sankeyDiagram_TZEHDZUN_nodes = [];
...
var addLink = /* @__PURE__ */ (0,chunk_AGHRB4JF/* .__name */.K2)((source, target, value) => {
  sankeyDiagram_TZEHDZUN_links.push(new SankeyLink(source, target, value));
}, "addLink");
...
var findOrCreateNode = /* @__PURE__ */ (0,chunk_AGHRB4JF/* .__name */.K2)((ID) => {
  ID = chunk_ABZYJK2D/* .common_default.sanitizeText */.Y2.sanitizeText(ID, (0,chunk_ABZYJK2D/* .getConfig2 */.D7)());
  let node = nodesMap.get(ID);
  if (node === void 0) {
    node = new SankeyNode(ID);
    nodesMap.set(ID, node);
    sankeyDiagram_TZEHDZUN_nodes.push(node);
  }
  return node;
}, "findOrCreateNode");
var getNodes = /* @__PURE__ */ (0,chunk_AGHRB4JF/* .__name */.K2)(() => sankeyDiagram_TZEHDZUN_nodes, "getNodes");
var getLinks = /* @__PURE__ */ (0,chunk_AGHRB4JF/* .__name */.K2)(() => sankeyDiagram_TZEHDZUN_links, "getLinks");
var getGraph = /* @__PURE__ */ (0,chunk_AGHRB4JF/* .__name */.K2)(() => ({
  nodes: sankeyDiagram_TZEHDZUN_nodes.map((node) => ({ id: node.ID })),
  links: sankeyDiagram_TZEHDZUN_links.map((link) => ({
...
var draw = /* @__PURE__ */ (0,chunk_AGHRB4JF/* .__name */.K2)(function(text, id, _version, diagObj) {
  ...
  const defaultSankeyConfig = chunk_ABZYJK2D/* .defaultConfig2.sankey */.ME.sankey;
  let sandboxElement;
...
//# sourceMappingURL=9690.96c4bbfc53fc9d7c.js.map?v=96c4bbfc53fc9d7c