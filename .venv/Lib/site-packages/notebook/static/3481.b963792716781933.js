"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["3481"], {
48288(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
/* import */ var _codemirror_language__rspack_import_0 = __webpack_require__(58540);
/* import */ var _codemirror_language__rspack_import_0_default = /*#__PURE__*/__webpack_require__.n(_codemirror_language__rspack_import_0);
/* import */ var _lezer_highlight__rspack_import_1 = __webpack_require__(6951);
/* import */ var _lezer_highlight__rspack_import_1_default = /*#__PURE__*/__webpack_require__.n(_lezer_highlight__rspack_import_1);
/* import */ var _lezer_lr__rspack_import_2 = __webpack_require__(5257);
/* import */ var _codemirror_autocomplete__rspack_import_3 = __webpack_require__(73343);
...
function tokensFor(d) {
    return new _lezer_lr__rspack_import_2/* .ExternalTokenizer */.Lu(input => {
        var _a;
        let { next } = input;
        input.advance();
...
// This file was generated by lezer-generator. You probably shouldn't edit it.
const parser$1 = /*@__PURE__*/_lezer_lr__rspack_import_2/* .LRParser.deserialize */.U1.deserialize({
  version: 14,
...
function sourceContext(state, startPos) {
    let pos = (0,_codemirror_language__rspack_import_0.syntaxTree)(state).resolveInner(startPos, -1);
...
function completeKeywords(keywords, upperCase, build) {
    ...
    return (0,_codemirror_autocomplete__rspack_import_3/* .ifNotIn */.Ar)(["QuotedIdentifier", "String", "LineComment", "BlockComment", "."], (0,_codemirror_autocomplete__rspack_import_3/* .completeFromList */.et)(completions));
}

let parser = /*@__PURE__*/parser$1.configure({
    props: [
        /*@__PURE__*/_codemirror_language__rspack_import_0.indentNodeProp.add({
            Statement: /*@__PURE__*/(0,_codemirror_language__rspack_import_0.continuedIndent)()
        }),
        /*@__PURE__*/_codemirror_language__rspack_import_0.foldNodeProp.add({
            Statement(tree, state) { return { from: Math.min(tree.from + 100, state.doc.lineAt(tree.from).to), to: tree.to }; },
            BlockComment(tree) { return { from: tree.from + 2, to: tree.to - 2 }; }
        }),
        /*@__PURE__*/(0,_lezer_highlight__rspack_import_1.styleTags)({
            Keyword: _lezer_highlight__rspack_import_1.tags.keyword,
            Type: _lezer_highlight__rspack_import_1.tags.typeName,
            Builtin: /*@__PURE__*/_lezer_highlight__rspack_import_1.tags.standard(_lezer_highlight__rspack_import_1.tags.name),
            Bits: _lezer_highlight__rspack_import_1.tags.number,
            Bytes: _lezer_highlight__rspack_import_1.tags.string,
            Bool: _lezer_highlight__rspack_import_1.tags.bool,
            Null: _lezer_highlight__rspack_import_1.tags["null"],
            Number: _lezer_highlight__rspack_import_1.tags.number,
            String: _lezer_highlight__rspack_import_1.tags.string,
            Identifier: _lezer_highlight__rspack_import_1.tags.name,
            QuotedIdentifier: /*@__PURE__*/_lezer_highlight__rspack_import_1.tags.special(_lezer_highlight__rspack_import_1.tags.string),
            SpecialVar: /*@__PURE__*/_lezer_highlight__rspack_import_1.tags.special(_lezer_highlight__rspack_import_1.tags.name),
            LineComment: _lezer_highlight__rspack_import_1.tags.lineComment,
            BlockComment: _lezer_highlight__rspack_import_1.tags.blockComment,
            Operator: _lezer_highlight__rspack_import_1.tags.operator,
            "Semi Punctuation": _lezer_highlight__rspack_import_1.tags.punctuation,
            "( )": _lezer_highlight__rspack_import_1.tags.paren,
            "{ }": _lezer_highlight__rspack_import_1.tags.brace,
            "[ ]": _lezer_highlight__rspack_import_1.tags.squareBracket
        })
    ]
});
/**
...
class SQLDialect {
    ...
    */
    static define(spec) {
        ...
        let language = _codemirror_language__rspack_import_0.LRLanguage.define({
            name: "sql",
...
function sql(config = {}) {
    ...
    return new _codemirror_language__rspack_import_0.LanguageSupport(lang.language, [
...
//# sourceMappingURL=3481.b963792716781933.js.map?v=b963792716781933