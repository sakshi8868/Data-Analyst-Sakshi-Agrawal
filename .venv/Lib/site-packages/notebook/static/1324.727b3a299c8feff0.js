"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([["1324"], {
...
var RequirementDB = class {
  constructor() {
    ...
    this.getConfig = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_11/* .__name */.K2)(() => (0,_chunk_ABZYJK2D_mjs__rspack_import_10/* .getConfig2 */.D7)().requirement, "getConfig");
    this.clear();
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__rspack_import_11/* .__name */.K2)(this, "RequirementDB");
  }
  getDirection() {
  ...
  addElement(name) {
    if (!this.elements.has(name)) {
      ...
      _chunk_AGHRB4JF_mjs__rspack_import_11/* .log.info */.Rm.info("Added new element: ", name);
    }
...
(0,_chunk_AGHRB4JF_mjs__rspack_import_11/* .__export */.VA)(requirementRenderer_exports, {
  draw: () => draw
});
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__rspack_import_11/* .__name */.K2)(async function(text, id, _version, diag) {
  ...
  _chunk_AGHRB4JF_mjs__rspack_import_11/* .log.info */.Rm.info("Drawing requirement diagram (unified)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_ABZYJK2D_mjs__rspack_import_10/* .getConfig2 */.D7)();
  ...
  (0,_chunk_QN33PNHL_mjs__rspack_import_1/* .setupViewPortForSVG */.P)(svg, padding, "requirementDiagram", conf?.useMaxWidth ?? true);
}, "draw");
...
//# sourceMappingURL=1324.727b3a299c8feff0.js.map?v=727b3a299c8feff0